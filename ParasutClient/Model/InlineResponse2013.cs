...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2013 :  IEquatable<InlineResponse2013>, IValidatableObject
    {
        ...
        public InlineResponse2013(Payment data = default(Payment), List<InlineResponse2013Included> included = default(List<InlineResponse2013Included>))
        {
            this.Data = data;
        ...
        public List<InlineResponse2013Included> Included { get; set; }
