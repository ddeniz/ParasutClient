...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesDataRelationshipsTags :  IEquatable<CompanyIdbankFeesDataRelationshipsTags>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdbankFeesDataRelationshipsTags);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesDataRelationshipsTags instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesDataRelationshipsTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesDataRelationshipsTags input)
        {
            if (input == null)
                return false;
