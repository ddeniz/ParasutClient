...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(List<Salary> data = default(List<Salary>), List<InlineResponse20012Included> included = default(List<InlineResponse20012Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
        ...
        public List<Salary> Data { get; set; }
