...
{
    /// <summary>
    /// ShipmentDocumentRelationshipsStockMovementsData
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentRelationshipsStockMovementsData :  IEquatable<ShipmentDocumentRelationshipsStockMovementsData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Stockmovements for value: stock_movements
            /// </summary>
            [EnumMember(Value = "stock_movements")]
            Stockmovements = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentRelationshipsStockMovementsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public ShipmentDocumentRelationshipsStockMovementsData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentRelationshipsStockMovementsData {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentRelationshipsStockMovementsData);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentRelationshipsStockMovementsData instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentRelationshipsStockMovementsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentRelationshipsStockMovementsData input)
        {
            if (input == null)
                return false;
