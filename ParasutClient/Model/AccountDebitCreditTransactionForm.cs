...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountDebitCreditTransactionForm :  IEquatable<AccountDebitCreditTransactionForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDebitCreditTransactionForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountDebitCreditTransactionForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDebitCreditTransactionForm" /> class.
        /// </summary>
        ...
        public AccountDebitCreditTransactionForm(string id = default(string), TypeEnum? type = default(TypeEnum?), AccountDebitCreditTransactionFormAttributes attributes = default(AccountDebitCreditTransactionFormAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for AccountDebitCreditTransactionForm and cannot be null");
            }
            else
            {
        ...
        public AccountDebitCreditTransactionFormAttributes Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountDebitCreditTransactionForm {\n");
        ...
        {
            return this.Equals(input as AccountDebitCreditTransactionForm);
        }

        /// <summary>
        /// Returns true if AccountDebitCreditTransactionForm instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountDebitCreditTransactionForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountDebitCreditTransactionForm input)
        {
            if (input == null)
                return false;
