...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData input)
        {
            if (input == null)
                return false;
