...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentRelationships :  IEquatable<PaymentRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public PaymentRelationships(PaymentRelationshipsPayable payable = default(PaymentRelationshipsPayable), PaymentRelationshipsTransaction transaction = default(PaymentRelationshipsTransaction))
        {
        ...
        public PaymentRelationshipsPayable Payable { get; set; }

        /// <summary>
        /// Gets or Sets Transaction
        /// </summary>
        [DataMember(Name="transaction", EmitDefaultValue=false)]
        public PaymentRelationshipsTransaction Transaction { get; set; }
        ...
        {
            return this.Equals(input as PaymentRelationships);
        }

        /// <summary>
        /// Returns true if PaymentRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRelationships input)
        {
            if (input == null)
                return false;
