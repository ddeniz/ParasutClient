...
{
    /// <summary>
    /// CompanyIdsalesInvoicesDataRelationshipsSalesOfferData
    /// </summary>
    [DataContract]
    public partial class CompanyIdsalesInvoicesDataRelationshipsSalesOfferData :  IEquatable<CompanyIdsalesInvoicesDataRelationshipsSalesOfferData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdsalesInvoicesDataRelationshipsSalesOfferData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public CompanyIdsalesInvoicesDataRelationshipsSalesOfferData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdsalesInvoicesDataRelationshipsSalesOfferData {\n");
        ...
        {
            return this.Equals(input as CompanyIdsalesInvoicesDataRelationshipsSalesOfferData);
        }

        /// <summary>
        /// Returns true if CompanyIdsalesInvoicesDataRelationshipsSalesOfferData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalesInvoicesDataRelationshipsSalesOfferData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalesInvoicesDataRelationshipsSalesOfferData input)
        {
            if (input == null)
                return false;
