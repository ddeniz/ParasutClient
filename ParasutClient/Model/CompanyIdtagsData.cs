...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdtagsData :  IEquatable<CompanyIdtagsData>, IValidatableObject
    {
        ...
        public CompanyIdtagsData(string id = default(string), TypeEnum? type = default(TypeEnum?), TagAttributes attributes = default(TagAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdtagsData);
        }

        /// <summary>
        /// Returns true if CompanyIdtagsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdtagsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdtagsData input)
        {
            if (input == null)
                return false;
