...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdeArchivesDataRelationshipsSalesInvoiceData :  IEquatable<CompanyIdeArchivesDataRelationshipsSalesInvoiceData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdeArchivesDataRelationshipsSalesInvoiceData);
        }

        /// <summary>
        /// Returns true if CompanyIdeArchivesDataRelationshipsSalesInvoiceData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdeArchivesDataRelationshipsSalesInvoiceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeArchivesDataRelationshipsSalesInvoiceData input)
        {
            if (input == null)
                return false;
