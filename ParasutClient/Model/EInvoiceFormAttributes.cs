...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EInvoiceFormAttributes : EDocumentCommonFormAttributes,  IEquatable<EInvoiceFormAttributes>, IValidatableObject
    {
        /// <summary>
        /// Gönderim senaryosu
        /// </summary>
        ...
        {
            return this.Equals(input as EInvoiceFormAttributes);
        }

        /// <summary>
        /// Returns true if EInvoiceFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoiceFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoiceFormAttributes input)
        {
            if (input == null)
                return false;
