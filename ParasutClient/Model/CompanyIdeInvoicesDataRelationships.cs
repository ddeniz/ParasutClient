...
{
    /// <summary>
    /// CompanyIdeInvoicesDataRelationships
    /// </summary>
    [DataContract]
    public partial class CompanyIdeInvoicesDataRelationships :  IEquatable<CompanyIdeInvoicesDataRelationships>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdeInvoicesDataRelationships" /> class.
        /// </summary>
        /// <param name="invoice">invoice.</param>
        public CompanyIdeInvoicesDataRelationships(CompanyIdeArchivesDataRelationshipsSalesInvoice invoice = default(CompanyIdeArchivesDataRelationshipsSalesInvoice))
        {
        ...
        public CompanyIdeArchivesDataRelationshipsSalesInvoice Invoice { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdeInvoicesDataRelationships {\n");
        ...
        {
            return this.Equals(input as CompanyIdeInvoicesDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdeInvoicesDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdeInvoicesDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeInvoicesDataRelationships input)
        {
            if (input == null)
                return false;
