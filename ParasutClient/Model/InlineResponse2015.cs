...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2015 :  IEquatable<InlineResponse2015>, IValidatableObject
    {
        ...
        public InlineResponse2015(TrackableJob data = default(TrackableJob))
        {
            this.Data = data;
        }
        ...
        public TrackableJob Data { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2015);
        }

        /// <summary>
        /// Returns true if InlineResponse2015 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2015 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2015 input)
        {
            if (input == null)
                return false;
