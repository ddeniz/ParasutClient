...
namespace ParasutClient.Model
{
    ...
    public partial class EDocumentPdfAttributes :  IEquatable<EDocumentPdfAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EDocumentPdfAttributes);
        }

        /// <summary>
        /// Returns true if EDocumentPdfAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EDocumentPdfAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentPdfAttributes input)
        {
            if (input == null)
                return false;
