...
{
    /// <summary>
    /// MeRelationshipsUserRoles
    /// </summary>
    [DataContract]
    public partial class MeRelationshipsUserRoles :  IEquatable<MeRelationshipsUserRoles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeRelationshipsUserRoles" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MeRelationshipsUserRoles(List<EmployeeRelationshipsManagedByUserRoleData> data = default(List<EmployeeRelationshipsManagedByUserRoleData>))
        {
            this.Data = data;
        }
        ...
        public List<EmployeeRelationshipsManagedByUserRoleData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeRelationshipsUserRoles {\n");
        ...
        {
            return this.Equals(input as MeRelationshipsUserRoles);
        }

        /// <summary>
        /// Returns true if MeRelationshipsUserRoles instances are equal
        /// </summary>
        /// <param name="input">Instance of MeRelationshipsUserRoles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeRelationshipsUserRoles input)
        {
            if (input == null)
                return false;
