...
namespace ParasutClient.Model
{
    ...
    public partial class Tag :  IEquatable<Tag>, IValidatableObject
    {
        ...
        public Tag(string id = default(string), TypeEnum? type = default(TypeEnum?), TagAttributes attributes = default(TagAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Tag and cannot be null");
            }
            else
            {
