...
{
    /// <summary>
    /// StockMovementRelationships
    /// </summary>
    [DataContract]
    public partial class StockMovementRelationships :  IEquatable<StockMovementRelationships>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StockMovementRelationships" /> class.
        /// </summary>
        ...
        public StockMovementRelationshipsSource Source { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StockMovementRelationships {\n");
        ...
        {
            return this.Equals(input as StockMovementRelationships);
        }

        /// <summary>
        /// Returns true if StockMovementRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of StockMovementRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockMovementRelationships input)
        {
            if (input == null)
                return false;
