...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdeArchivesDataRelationships :  IEquatable<CompanyIdeArchivesDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdeArchivesDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdeArchivesDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdeArchivesDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeArchivesDataRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.SalesInvoice == input.SalesInvoice ||
                    (this.SalesInvoice != null &&
                    this.SalesInvoice.Equals(input.SalesInvoice))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SalesInvoice != null)
                    hashCode = hashCode * 59 + this.SalesInvoice.GetHashCode();
                return hashCode;
            }
        }
