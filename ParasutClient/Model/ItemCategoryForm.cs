...
namespace ParasutClient.Model
{
    ...
    public partial class ItemCategoryForm :  IEquatable<ItemCategoryForm>, IValidatableObject
    {
        ...
        public ItemCategoryForm(CompanyIditemCategoriesData data = default(CompanyIditemCategoriesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ItemCategoryForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as ItemCategoryForm);
        }

        /// <summary>
        /// Returns true if ItemCategoryForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemCategoryForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemCategoryForm input)
        {
            if (input == null)
                return false;
