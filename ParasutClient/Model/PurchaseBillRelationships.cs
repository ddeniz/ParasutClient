...
{
    /// <summary>
    /// PurchaseBillRelationships
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationships :  IEquatable<PurchaseBillRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public PurchaseBillRelationshipsDetails Details { get; set; }
        ...
        public PurchaseBillRelationshipsActiveEDocument ActiveEDocument { get; set; }

        /// <summary>
        /// Gets or Sets PayTo
        /// </summary>
        [DataMember(Name="pay_to", EmitDefaultValue=false)]
        public PurchaseBillRelationshipsPayTo PayTo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationships {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationships);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationships input)
        {
            if (input == null)
                return false;
