...
namespace ParasutClient.Model
{
    ...
    public partial class EmployeeForm1 :  IEquatable<EmployeeForm1>, IValidatableObject
    {
        ...
        public EmployeeForm1(CompanyIdemployeesData data = default(CompanyIdemployeesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for EmployeeForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as EmployeeForm1);
        }

        /// <summary>
        /// Returns true if EmployeeForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeForm1 input)
        {
            if (input == null)
                return false;
