...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(List<ItemCategory> data = default(List<ItemCategory>), List<InlineResponse2009Included> included = default(List<InlineResponse2009Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
