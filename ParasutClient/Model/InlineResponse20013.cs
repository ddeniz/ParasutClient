...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20013 :  IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        public InlineResponse20013(List<SalesInvoice> data = default(List<SalesInvoice>), List<InlineResponse20013Included> included = default(List<InlineResponse20013Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
