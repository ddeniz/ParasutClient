...
{
    /// <summary>
    /// InlineResponse20011Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011Included :  IEquatable<InlineResponse20011Included>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse20011Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011Included);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Included input)
        {
            if (input == null)
                return false;
