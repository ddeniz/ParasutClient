...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesDataRelationshipsCategoryData :  IEquatable<CompanyIdbankFeesDataRelationshipsCategoryData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdbankFeesDataRelationshipsCategoryData);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesDataRelationshipsCategoryData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesDataRelationshipsCategoryData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesDataRelationshipsCategoryData input)
        {
            if (input == null)
                return false;
