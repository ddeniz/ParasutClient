...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(List<Tax> data = default(List<Tax>), List<InlineResponse2012Included> included = default(List<InlineResponse2012Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
