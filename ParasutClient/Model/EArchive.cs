...
namespace ParasutClient.Model
{
    ...
    public partial class EArchive :  IEquatable<EArchive>, IValidatableObject
    {
        ...
        public EArchive(string id = default(string), TypeEnum? type = default(TypeEnum?), EArchiveAttributes attributes = default(EArchiveAttributes), CompanyIdeArchivesDataRelationships relationships = default(CompanyIdeArchivesDataRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for EArchive and cannot be null");
            }
            else
            {
        ...
        public EArchiveAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as EArchive);
        }

        /// <summary>
        /// Returns true if EArchive instances are equal
        /// </summary>
        /// <param name="input">Instance of EArchive to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EArchive input)
        {
            if (input == null)
                return false;
