...
{
    /// <summary>
    /// SalesInvoiceRelationships
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationships :  IEquatable<SalesInvoiceRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public SalesInvoiceRelationshipsDetails Details { get; set; }

        /// <summary>
        /// Gets or Sets Payments
        /// </summary>
        [DataMember(Name="payments", EmitDefaultValue=false)]
        public PurchaseBillRelationshipsPayments Payments { get; set; }
        ...
        /// <summary>
        /// Gets or Sets SalesOffer
        /// </summary>
        [DataMember(Name="sales_offer", EmitDefaultValue=false)]
        public CompanyIdsalesInvoicesDataRelationshipsSalesOffer SalesOffer { get; set; }

        /// <summary>
        /// Gets or Sets Sharings
        /// </summary>
        [DataMember(Name="sharings", EmitDefaultValue=false)]
        public SalesInvoiceRelationshipsSharings Sharings { get; set; }

        /// <summary>
        /// Gets or Sets RecurrencePlan
        /// </summary>
        [DataMember(Name="recurrence_plan", EmitDefaultValue=false)]
        public PurchaseBillRelationshipsRecurrencePlan RecurrencePlan { get; set; }

        /// <summary>
        /// Gets or Sets ActiveEDocument
        /// </summary>
        [DataMember(Name="active_e_document", EmitDefaultValue=false)]
        public SalesInvoiceRelationshipsActiveEDocument ActiveEDocument { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationships {\n");
            sb.Append("  Category: ").Append(Category).Append("\n");
            sb.Append("  Contact: ").Append(Contact).Append("\n");
            sb.Append("  Details: ").Append(Details).Append("\n");
            sb.Append("  Payments: ").Append(Payments).Append("\n");
            sb.Append("  Tags: ").Append(Tags).Append("\n");
            sb.Append("  SalesOffer: ").Append(SalesOffer).Append("\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationships);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SalesOffer == input.SalesOffer ||
                    (this.SalesOffer != null &&
                    this.SalesOffer.Equals(input.SalesOffer))
                ) && 
                (
                    this.Sharings == input.Sharings ||
                    (this.Sharings != null &&
                    this.Sharings.Equals(input.Sharings))
                ) && 
                (
                    this.RecurrencePlan == input.RecurrencePlan ||
                    (this.RecurrencePlan != null &&
                    this.RecurrencePlan.Equals(input.RecurrencePlan))
                ) && 
                (
                    this.ActiveEDocument == input.ActiveEDocument ||
                    (this.ActiveEDocument != null &&
                    this.ActiveEDocument.Equals(input.ActiveEDocument))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SalesOffer != null)
                    hashCode = hashCode * 59 + this.SalesOffer.GetHashCode();
                if (this.Sharings != null)
                    hashCode = hashCode * 59 + this.Sharings.GetHashCode();
                if (this.RecurrencePlan != null)
                    hashCode = hashCode * 59 + this.RecurrencePlan.GetHashCode();
                if (this.ActiveEDocument != null)
                    hashCode = hashCode * 59 + this.ActiveEDocument.GetHashCode();
                return hashCode;
            }
        }
