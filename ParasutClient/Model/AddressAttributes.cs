...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressAttributes :  IEquatable<AddressAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressAttributes" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressAttributes {\n");
        ...
        {
            return this.Equals(input as AddressAttributes);
        }

        /// <summary>
        /// Returns true if AddressAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressAttributes input)
        {
            if (input == null)
                return false;
