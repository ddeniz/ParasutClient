...
namespace ParasutClient.Model
{
    ...
    public partial class EInvoiceForm :  IEquatable<EInvoiceForm>, IValidatableObject
    {
        ...
        public EInvoiceForm(CompanyIdeInvoicesData data = default(CompanyIdeInvoicesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for EInvoiceForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as EInvoiceForm);
        }

        /// <summary>
        /// Returns true if EInvoiceForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoiceForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoiceForm input)
        {
            if (input == null)
                return false;
