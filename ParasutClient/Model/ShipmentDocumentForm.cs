...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentForm :  IEquatable<ShipmentDocumentForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShipmentDocumentForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentForm" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public ShipmentDocumentForm(CompanyIdshipmentDocumentsData data = default(CompanyIdshipmentDocumentsData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ShipmentDocumentForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentForm {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentForm);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentForm input)
        {
            if (input == null)
                return false;
