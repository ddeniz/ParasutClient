...
namespace ParasutClient.Model
{
    ...
    public partial class TransactionAttributes :  IEquatable<TransactionAttributes>, IValidatableObject
    {
        ...
        /// Alacak döviz cinsi
        /// </summary>
        /// <value>Alacak döviz cinsi</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="transactionType">İşlem türü.</param>
        /// <param name="date">Tarih.</param>
        /// <param name="amountInTrl">TRL karşılığı meblağ.</param>
        /// <param name="debitAmount">Borç meblağ.</param>
        /// <param name="debitCurrency">Borç döviz cinsi.</param>
        /// <param name="creditAmount">Alacak meblağ.</param>
        /// <param name="creditCurrency">Alacak döviz cinsi.</param>
        public TransactionAttributes(string description = default(string), string transactionType = default(string), DateTime? date = default(DateTime?), decimal? amountInTrl = default(decimal?), decimal? debitAmount = default(decimal?), DebitCurrencyEnum? debitCurrency = default(DebitCurrencyEnum?), decimal? creditAmount = default(decimal?), CreditCurrencyEnum? creditCurrency = default(CreditCurrencyEnum?))
        {
        ...
        /// </summary>
        /// <value>TRL karşılığı meblağ</value>
        ...
        public bool Equals(TransactionAttributes input)
        {
            ...
            return 
                ...
                (
                    this.AmountInTrl == input.AmountInTrl ||
                    (this.AmountInTrl != null &&
                    this.AmountInTrl.Equals(input.AmountInTrl))
                ) && 
                (
                ...
                (
                    this.DebitCurrency == input.DebitCurrency ||
                    (this.DebitCurrency != null &&
                    this.DebitCurrency.Equals(input.DebitCurrency))
                ) && 
                (
                ...
                (
                    this.CreditCurrency == input.CreditCurrency ||
                    (this.CreditCurrency != null &&
                    this.CreditCurrency.Equals(input.CreditCurrency))
                );
        }
