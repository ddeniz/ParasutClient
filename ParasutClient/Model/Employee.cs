...
namespace ParasutClient.Model
{
    ...
    public partial class Employee :  IEquatable<Employee>, IValidatableObject
    {
        ...
        public Employee(string id = default(string), TypeEnum? type = default(TypeEnum?), EmployeeAttributes attributes = default(EmployeeAttributes), EmployeeRelationships relationships = default(EmployeeRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Employee and cannot be null");
            }
            else
            {
        ...
        public EmployeeRelationships Relationships { get; set; }
