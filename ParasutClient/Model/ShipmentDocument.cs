...
namespace ParasutClient.Model
{
    ...
    public partial class ShipmentDocument :  IEquatable<ShipmentDocument>, IValidatableObject
    {
        ...
        public ShipmentDocument(string id = default(string), TypeEnum? type = default(TypeEnum?), ShipmentDocumentAttributes attributes = default(ShipmentDocumentAttributes), ShipmentDocumentRelationships relationships = default(ShipmentDocumentRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for ShipmentDocument and cannot be null");
            }
            else
            {
        ...
        public ShipmentDocumentRelationships Relationships { get; set; }
