...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20114 :  IEquatable<InlineResponse20114>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20114" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="included">included.</param>
        public InlineResponse20114(Tax data = default(Tax), List<InlineResponse2012Included> included = default(List<InlineResponse2012Included>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as InlineResponse20114);
        }

        /// <summary>
        /// Returns true if InlineResponse20114 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20114 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20114 input)
        {
            if (input == null)
                return false;
