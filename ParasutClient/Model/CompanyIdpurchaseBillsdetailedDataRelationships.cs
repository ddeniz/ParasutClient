...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedDataRelationships :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PaidByEmployee == input.PaidByEmployee ||
                    (this.PaidByEmployee != null &&
                    this.PaidByEmployee.Equals(input.PaidByEmployee))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaidByEmployee != null)
                    hashCode = hashCode * 59 + this.PaidByEmployee.GetHashCode();
