...
{
    /// <summary>
    /// EInvoiceRelationshipsInvoiceData
    /// </summary>
    [DataContract]
    public partial class EInvoiceRelationshipsInvoiceData :  IEquatable<EInvoiceRelationshipsInvoiceData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EInvoiceRelationshipsInvoiceData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public EInvoiceRelationshipsInvoiceData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EInvoiceRelationshipsInvoiceData {\n");
        ...
        {
            return this.Equals(input as EInvoiceRelationshipsInvoiceData);
        }

        /// <summary>
        /// Returns true if EInvoiceRelationshipsInvoiceData instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoiceRelationshipsInvoiceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoiceRelationshipsInvoiceData input)
        {
            if (input == null)
                return false;
