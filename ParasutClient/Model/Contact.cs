...
namespace ParasutClient.Model
{
    ...
    public partial class Contact :  IEquatable<Contact>, IValidatableObject
    {
        ...
        public Contact(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactAttributes attributes = default(ContactAttributes), ContactRelationships relationships = default(ContactRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Contact and cannot be null");
            }
            else
            {
