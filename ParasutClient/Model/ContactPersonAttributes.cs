...
namespace ParasutClient.Model
{
    ...
    public partial class ContactPersonAttributes :  IEquatable<ContactPersonAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ContactPersonAttributes);
        }

        /// <summary>
        /// Returns true if ContactPersonAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactPersonAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactPersonAttributes input)
        {
            if (input == null)
                return false;
