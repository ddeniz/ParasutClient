...
{
    /// <summary>
    /// ContactRelationshipsContactPortal
    /// </summary>
    [DataContract]
    public partial class ContactRelationshipsContactPortal :  IEquatable<ContactRelationshipsContactPortal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactRelationshipsContactPortal" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ContactRelationshipsContactPortal(ContactRelationshipsContactPortalData data = default(ContactRelationshipsContactPortalData))
        {
            this.Data = data;
        }
        ...
        public ContactRelationshipsContactPortalData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactRelationshipsContactPortal {\n");
        ...
        {
            return this.Equals(input as ContactRelationshipsContactPortal);
        }

        /// <summary>
        /// Returns true if ContactRelationshipsContactPortal instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactRelationshipsContactPortal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRelationshipsContactPortal input)
        {
            if (input == null)
                return false;
