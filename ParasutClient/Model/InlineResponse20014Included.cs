...
{
    /// <summary>
    /// InlineResponse20014Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse20014Included :  IEquatable<InlineResponse20014Included>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Salesinvoices for value: sales_invoices
            /// </summary>
            [EnumMember(Value = "sales_invoices")]
            Salesinvoices = 4,
            
            /// <summary>
            /// Enum Purchasebills for value: purchase_bills
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20014Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse20014Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20014Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse20014Included);
        }

        /// <summary>
        /// Returns true if InlineResponse20014Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20014Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20014Included input)
        {
            if (input == null)
                return false;
