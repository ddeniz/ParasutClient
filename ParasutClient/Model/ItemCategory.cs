...
namespace ParasutClient.Model
{
    ...
    public partial class ItemCategory :  IEquatable<ItemCategory>, IValidatableObject
    {
        ...
        public ItemCategory(string id = default(string), TypeEnum? type = default(TypeEnum?), ItemCategoryAttributes attributes = default(ItemCategoryAttributes), ItemCategoryRelationships relationships = default(ItemCategoryRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for ItemCategory and cannot be null");
            }
            else
            {
        ...
        public ItemCategoryAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public ItemCategoryRelationships Relationships { get; set; }
        ...
        {
            return this.Equals(input as ItemCategory);
        }

        /// <summary>
        /// Returns true if ItemCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemCategory input)
        {
            if (input == null)
                return false;
