...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentForm4 :  IEquatable<PaymentForm4>, IValidatableObject
    {
        ...
        public PaymentForm4(CompanyIdbankFeesidpaymentsData data = default(CompanyIdbankFeesidpaymentsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PaymentForm4 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PaymentForm4);
        }

        /// <summary>
        /// Returns true if PaymentForm4 instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentForm4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentForm4 input)
        {
            if (input == null)
                return false;
