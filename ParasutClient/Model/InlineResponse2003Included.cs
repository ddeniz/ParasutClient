...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2003Included :  IEquatable<InlineResponse2003Included>, IValidatableObject
    {
        ...
        public InlineResponse2003Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse2003Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2003Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003Included input)
        {
            if (input == null)
                return false;
