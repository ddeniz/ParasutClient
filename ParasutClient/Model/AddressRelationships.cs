...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressRelationships :  IEquatable<AddressRelationships>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressRelationships" /> class.
        /// </summary>
        /// <param name="addressable">addressable.</param>
        public AddressRelationships(AddressRelationshipsAddressable addressable = default(AddressRelationshipsAddressable))
        {
        ...
        /// </summary>
        [DataMember(Name="addressable", EmitDefaultValue=false)]
        public AddressRelationshipsAddressable Addressable { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressRelationships {\n");
            sb.Append("  Addressable: ").Append(Addressable).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AddressRelationships);
        }

        /// <summary>
        /// Returns true if AddressRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Addressable == input.Addressable ||
                    (this.Addressable != null &&
                    this.Addressable.Equals(input.Addressable))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Addressable != null)
                    hashCode = hashCode * 59 + this.Addressable.GetHashCode();
                return hashCode;
            }
        }
