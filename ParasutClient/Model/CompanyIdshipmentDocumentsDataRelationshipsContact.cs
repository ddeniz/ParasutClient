...
{
    /// <summary>
    /// CompanyIdshipmentDocumentsDataRelationshipsContact
    /// </summary>
    [DataContract]
    public partial class CompanyIdshipmentDocumentsDataRelationshipsContact :  IEquatable<CompanyIdshipmentDocumentsDataRelationshipsContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdshipmentDocumentsDataRelationshipsContact" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CompanyIdshipmentDocumentsDataRelationshipsContact(CompanyIdshipmentDocumentsDataRelationshipsContactData data = default(CompanyIdshipmentDocumentsDataRelationshipsContactData))
        {
            this.Data = data;
        }
        ...
        public CompanyIdshipmentDocumentsDataRelationshipsContactData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdshipmentDocumentsDataRelationshipsContact {\n");
        ...
        {
            return this.Equals(input as CompanyIdshipmentDocumentsDataRelationshipsContact);
        }

        /// <summary>
        /// Returns true if CompanyIdshipmentDocumentsDataRelationshipsContact instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdshipmentDocumentsDataRelationshipsContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdshipmentDocumentsDataRelationshipsContact input)
        {
            if (input == null)
                return false;
