...
namespace ParasutClient.Model
{
    ...
    public partial class Salary :  IEquatable<Salary>, IValidatableObject
    {
        ...
        public Salary(string id = default(string), TypeEnum? type = default(TypeEnum?), SalaryAttributes attributes = default(SalaryAttributes), CompanyIdsalariesDataRelationships relationships = default(CompanyIdsalariesDataRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Salary and cannot be null");
            }
            else
            {
