...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdcontactsidcontactDebitTransactionsData :  IEquatable<CompanyIdcontactsidcontactDebitTransactionsData>, IValidatableObject
    {
        ...
        public CompanyIdcontactsidcontactDebitTransactionsData(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactCollectionFormAttributes attributes = default(ContactCollectionFormAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdcontactsidcontactDebitTransactionsData);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsidcontactDebitTransactionsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdcontactsidcontactDebitTransactionsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsidcontactDebitTransactionsData input)
        {
            if (input == null)
                return false;
