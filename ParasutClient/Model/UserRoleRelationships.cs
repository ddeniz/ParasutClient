...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserRoleRelationships :  IEquatable<UserRoleRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public AddressRelationshipsAddressable Company { get; set; }

        /// <summary>
        /// Gets or Sets User
        /// </summary>
        [DataMember(Name="user", EmitDefaultValue=false)]
        public CompanyRelationshipsOwner User { get; set; }

        /// <summary>
        /// Gets or Sets ManagedEmployee
        /// </summary>
        [DataMember(Name="managed_employee", EmitDefaultValue=false)]
        public CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee ManagedEmployee { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserRoleRelationships {\n");
            sb.Append("  Company: ").Append(Company).Append("\n");
            sb.Append("  User: ").Append(User).Append("\n");
            sb.Append("  ManagedEmployee: ").Append(ManagedEmployee).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UserRoleRelationships);
        }

        /// <summary>
        /// Returns true if UserRoleRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of UserRoleRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserRoleRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ManagedEmployee == input.ManagedEmployee ||
                    (this.ManagedEmployee != null &&
                    this.ManagedEmployee.Equals(input.ManagedEmployee))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ManagedEmployee != null)
                    hashCode = hashCode * 59 + this.ManagedEmployee.GetHashCode();
                return hashCode;
            }
        }
