...
namespace ParasutClient.Model
{
    ...
    public partial class ItemCategoryAttributes :  IEquatable<ItemCategoryAttributes>, IValidatableObject
    {
        ...
        public enum CategoryTypeEnum
        {
            ...
            /// <summary>
            /// Enum SalesInvoice for value: SalesInvoice
            /// </summary>
            [EnumMember(Value = "SalesInvoice")]
            SalesInvoice = 4,
            
            /// <summary>
            /// Enum Expenditure for value: Expenditure
            /// </summary>
            [EnumMember(Value = "Expenditure")]
            Expenditure = 5
        }
        ...
        {
            return this.Equals(input as ItemCategoryAttributes);
        }

        /// <summary>
        /// Returns true if ItemCategoryAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemCategoryAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemCategoryAttributes input)
        {
            if (input == null)
                return false;
