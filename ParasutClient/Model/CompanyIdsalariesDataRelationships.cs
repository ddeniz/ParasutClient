...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdsalariesDataRelationships :  IEquatable<CompanyIdsalariesDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdsalariesDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdsalariesDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalariesDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalariesDataRelationships input)
        {
            if (input == null)
                return false;
