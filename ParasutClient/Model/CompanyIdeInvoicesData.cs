...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdeInvoicesData :  IEquatable<CompanyIdeInvoicesData>, IValidatableObject
    {
        ...
        public CompanyIdeInvoicesData(string id = default(string), TypeEnum? type = default(TypeEnum?), EInvoiceFormAttributes attributes = default(EInvoiceFormAttributes), CompanyIdeInvoicesDataRelationships relationships = default(CompanyIdeInvoicesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public EInvoiceFormAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public CompanyIdeInvoicesDataRelationships Relationships { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdeInvoicesData);
        }

        /// <summary>
        /// Returns true if CompanyIdeInvoicesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdeInvoicesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeInvoicesData input)
        {
            if (input == null)
                return false;
