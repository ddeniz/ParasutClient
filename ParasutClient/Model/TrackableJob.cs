...
namespace ParasutClient.Model
{
    ...
    public partial class TrackableJob :  IEquatable<TrackableJob>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Trackablejobs for value: trackable_jobs
            /// </summary>
        ...
        public TrackableJob(string id = default(string), TypeEnum? type = default(TypeEnum?), TrackableJobAttributes attributes = default(TrackableJobAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for TrackableJob and cannot be null");
            }
            else
            {
        ...
        public TrackableJobAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as TrackableJob);
        }

        /// <summary>
        /// Returns true if TrackableJob instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackableJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackableJob input)
        {
            if (input == null)
                return false;
