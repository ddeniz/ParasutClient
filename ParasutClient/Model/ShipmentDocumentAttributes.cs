...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentAttributes :  IEquatable<ShipmentDocumentAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShipmentDocumentAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentAttributes" /> class.
        /// </summary>
        /// <param name="inflow">İrsaliye tipi.</param>
        /// <param name="description">İrsaliye açıklaması.</param>
        ...
        /// <param name="shipmentDate">Fiili sevk tarihi.</param>
        /// <param name="procurementNumber">İrsaliye Numarası.</param>
        public ShipmentDocumentAttributes(bool? inflow = default(bool?), string description = default(string), string city = default(string), string district = default(string), string address = default(string), DateTime? issueDate = default(DateTime?), DateTime? shipmentDate = default(DateTime?), string procurementNumber = default(string))
        {
            // to ensure "issueDate" is required (not null)
            if (issueDate == null)
            {
                throw new InvalidDataException("issueDate is a required property for ShipmentDocumentAttributes and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Yazdırmaya özel fatura numarası</value>
        ...
        /// Yazdırmaya özel not
        /// </summary>
        /// <value>Yazdırmaya özel not</value>
        [DataMember(Name="print_note", EmitDefaultValue=false)]
        public string PrintNote { get; private set; }

        /// <summary>
        /// Yazdırılma tarihi
        /// </summary>
        /// <value>Yazdırılma tarihi</value>
        ...
        /// İrsaliye tipi
        /// </summary>
        /// <value>İrsaliye tipi</value>
        [DataMember(Name="inflow", EmitDefaultValue=false)]
        public bool? Inflow { get; set; }

        /// <summary>
        /// İrsaliye açıklaması
        /// </summary>
        /// <value>İrsaliye açıklaması</value>
        ...
        /// İrsaliye Numarası
        /// </summary>
        /// <value>İrsaliye Numarası</value>
        [DataMember(Name="procurement_number", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentAttributes {\n");
            sb.Append("  Archived: ").Append(Archived).Append("\n");
            sb.Append("  InvoiceNo: ").Append(InvoiceNo).Append("\n");
            sb.Append("  PrintNote: ").Append(PrintNote).Append("\n");
            ...
            sb.Append("  ProcurementNumber: ").Append(ProcurementNumber).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShipmentDocumentAttributes);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PrintNote == input.PrintNote ||
                    (this.PrintNote != null &&
                    this.PrintNote.Equals(input.PrintNote))
                ) && 
                (
                    this.PrintedAt == input.PrintedAt ||
                    (this.PrintedAt != null &&
                    this.PrintedAt.Equals(input.PrintedAt))
                ) && 
                (
                ...
                (
                    this.Inflow == input.Inflow ||
                    (this.Inflow != null &&
                    this.Inflow.Equals(input.Inflow))
                ) && 
                (
                ...
                (
                    this.ProcurementNumber == input.ProcurementNumber ||
                    (this.ProcurementNumber != null &&
                    this.ProcurementNumber.Equals(input.ProcurementNumber))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrintNote != null)
                    hashCode = hashCode * 59 + this.PrintNote.GetHashCode();
                if (this.PrintedAt != null)
                    hashCode = hashCode * 59 + this.PrintedAt.GetHashCode();
                if (this.CreatedAt != null)
                    hashCode = hashCode * 59 + this.CreatedAt.GetHashCode();
                if (this.UpdatedAt != null)
                    hashCode = hashCode * 59 + this.UpdatedAt.GetHashCode();
                if (this.Inflow != null)
                    hashCode = hashCode * 59 + this.Inflow.GetHashCode();
                ...
                if (this.ProcurementNumber != null)
                    hashCode = hashCode * 59 + this.ProcurementNumber.GetHashCode();
                return hashCode;
            }
        }
