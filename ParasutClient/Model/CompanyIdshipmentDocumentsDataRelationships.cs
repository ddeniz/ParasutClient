...
{
    /// <summary>
    /// CompanyIdshipmentDocumentsDataRelationships
    /// </summary>
    [DataContract]
    public partial class CompanyIdshipmentDocumentsDataRelationships :  IEquatable<CompanyIdshipmentDocumentsDataRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets StockMovements
        /// </summary>
        [DataMember(Name="stock_movements", EmitDefaultValue=false)]
        public CompanyIdshipmentDocumentsDataRelationshipsStockMovements StockMovements { get; set; }

        /// <summary>
        /// Gets or Sets Contact
        /// </summary>
        [DataMember(Name="contact", EmitDefaultValue=false)]
        public CompanyIdshipmentDocumentsDataRelationshipsContact Contact { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdshipmentDocumentsDataRelationships {\n");
            sb.Append("  StockMovements: ").Append(StockMovements).Append("\n");
        ...
        {
            return this.Equals(input as CompanyIdshipmentDocumentsDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdshipmentDocumentsDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdshipmentDocumentsDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdshipmentDocumentsDataRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.StockMovements == input.StockMovements ||
                    (this.StockMovements != null &&
                    this.StockMovements.Equals(input.StockMovements))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StockMovements != null)
                    hashCode = hashCode * 59 + this.StockMovements.GetHashCode();
