...
namespace ParasutClient.Model
{
    ...
    public partial class TransactionForm1 :  IEquatable<TransactionForm1>, IValidatableObject
    {
        ...
        protected TransactionForm1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionForm1" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public TransactionForm1(CompanyIdaccountsiddebitTransactionsData data = default(CompanyIdaccountsiddebitTransactionsData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TransactionForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public CompanyIdaccountsiddebitTransactionsData Data { get; set; }
        ...
        {
            return this.Equals(input as TransactionForm1);
        }

        /// <summary>
        /// Returns true if TransactionForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionForm1 input)
        {
            if (input == null)
                return false;
