...
{
    /// <summary>
    /// PurchaseBillRelationshipsRecurrencePlanData
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsRecurrencePlanData :  IEquatable<PurchaseBillRelationshipsRecurrencePlanData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsRecurrencePlanData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PurchaseBillRelationshipsRecurrencePlanData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsRecurrencePlanData {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsRecurrencePlanData);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsRecurrencePlanData instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsRecurrencePlanData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsRecurrencePlanData input)
        {
            if (input == null)
                return false;
