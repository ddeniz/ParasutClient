...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<Contact> data = default(List<Contact>), List<InlineResponse2003Included> included = default(List<InlineResponse2003Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
