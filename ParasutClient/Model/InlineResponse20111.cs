...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20111 :  IEquatable<InlineResponse20111>, IValidatableObject
    {
        ...
        public InlineResponse20111(SalesInvoice data = default(SalesInvoice), List<InlineResponse20013Included> included = default(List<InlineResponse20013Included>))
        {
            this.Data = data;
        ...
        public SalesInvoice Data { get; set; }

        /// <summary>
        /// Gets or Sets Included
        /// </summary>
        [DataMember(Name="included", EmitDefaultValue=false)]
        public List<InlineResponse20013Included> Included { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20111);
        }

        /// <summary>
        /// Returns true if InlineResponse20111 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20111 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20111 input)
        {
            if (input == null)
                return false;
