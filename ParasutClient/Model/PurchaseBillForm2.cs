...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillForm2 :  IEquatable<PurchaseBillForm2>, IValidatableObject
    {
        ...
        public PurchaseBillForm2(CompanyIdpurchaseBillsbasicData data = default(CompanyIdpurchaseBillsbasicData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PurchaseBillForm2 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PurchaseBillForm2);
        }

        /// <summary>
        /// Returns true if PurchaseBillForm2 instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillForm2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillForm2 input)
        {
            if (input == null)
                return false;
