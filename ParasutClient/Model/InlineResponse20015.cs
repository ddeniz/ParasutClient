...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>, IValidatableObject
    {
        ...
        public InlineResponse20015(List<StockMovement> data = default(List<StockMovement>), List<InlineResponse20015Included> included = default(List<InlineResponse20015Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
        ...
        public List<InlineResponse20015Included> Included { get; set; }
