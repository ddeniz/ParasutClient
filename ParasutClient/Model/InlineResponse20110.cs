...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20110 :  IEquatable<InlineResponse20110>, IValidatableObject
    {
        ...
        public InlineResponse20110(Salary data = default(Salary), List<InlineResponse20012Included> included = default(List<InlineResponse20012Included>))
        {
            this.Data = data;
        ...
        public Salary Data { get; set; }

        /// <summary>
        /// Gets or Sets Included
        /// </summary>
        [DataMember(Name="included", EmitDefaultValue=false)]
        public List<InlineResponse20012Included> Included { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20110);
        }

        /// <summary>
        /// Returns true if InlineResponse20110 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20110 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20110 input)
        {
            if (input == null)
                return false;
