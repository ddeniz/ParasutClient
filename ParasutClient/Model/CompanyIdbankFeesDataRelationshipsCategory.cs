...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesDataRelationshipsCategory :  IEquatable<CompanyIdbankFeesDataRelationshipsCategory>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdbankFeesDataRelationshipsCategory);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesDataRelationshipsCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesDataRelationshipsCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesDataRelationshipsCategory input)
        {
            if (input == null)
                return false;
