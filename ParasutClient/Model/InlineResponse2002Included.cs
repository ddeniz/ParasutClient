...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2002Included :  IEquatable<InlineResponse2002Included>, IValidatableObject
    {
        ...
        public InlineResponse2002Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse2002Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2002Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002Included input)
        {
            if (input == null)
                return false;
