...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(EInvoice data = default(EInvoice), List<InlineResponse2007Included> included = default(List<InlineResponse2007Included>))
        {
            this.Data = data;
