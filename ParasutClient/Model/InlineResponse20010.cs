...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(List<Product> data = default(List<Product>), List<InlineResponse2009Included> included = default(List<InlineResponse2009Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
