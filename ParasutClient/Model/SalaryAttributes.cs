...
namespace ParasutClient.Model
{
    ...
    public partial class SalaryAttributes :  IEquatable<SalaryAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SalaryAttributes);
        }

        /// <summary>
        /// Returns true if SalaryAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of SalaryAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalaryAttributes input)
        {
            if (input == null)
                return false;
