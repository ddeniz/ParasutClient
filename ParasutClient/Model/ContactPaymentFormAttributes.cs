...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactPaymentFormAttributes : PaymentFormAttributes,  IEquatable<ContactPaymentFormAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactPaymentFormAttributes(List<int?> payableIds = default(List<int?>), string description = default(string), int? accountId = default(int?), DateTime? date = default(DateTime?), decimal? amount = default(decimal?), decimal? exchangeRate = default(decimal?)) : base(description, accountId, date, amount, exchangeRate)
        {
        ...
        {
            return this.Equals(input as ContactPaymentFormAttributes);
        }

        /// <summary>
        /// Returns true if ContactPaymentFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactPaymentFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactPaymentFormAttributes input)
        {
            if (input == null)
                return false;
