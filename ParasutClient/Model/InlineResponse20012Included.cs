...
{
    /// <summary>
    /// InlineResponse20012Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012Included :  IEquatable<InlineResponse20012Included>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse20012Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20012Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse20012Included);
        }

        /// <summary>
        /// Returns true if InlineResponse20012Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20012Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012Included input)
        {
            if (input == null)
                return false;
