...
{
    /// <summary>
    /// EInvoiceRelationshipsInvoice
    /// </summary>
    [DataContract]
    public partial class EInvoiceRelationshipsInvoice :  IEquatable<EInvoiceRelationshipsInvoice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EInvoiceRelationshipsInvoice" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EInvoiceRelationshipsInvoice(EInvoiceRelationshipsInvoiceData data = default(EInvoiceRelationshipsInvoiceData))
        {
            this.Data = data;
        }
        ...
        public EInvoiceRelationshipsInvoiceData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EInvoiceRelationshipsInvoice {\n");
        ...
        {
            return this.Equals(input as EInvoiceRelationshipsInvoice);
        }

        /// <summary>
        /// Returns true if EInvoiceRelationshipsInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoiceRelationshipsInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoiceRelationshipsInvoice input)
        {
            if (input == null)
                return false;
