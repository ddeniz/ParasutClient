...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsbasicDataRelationships :  IEquatable<CompanyIdpurchaseBillsbasicDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsbasicDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsbasicDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsbasicDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsbasicDataRelationships input)
        {
            if (input == null)
                return false;
