...
namespace ParasutClient.Model
{
    ...
    public partial class AccountForm :  IEquatable<AccountForm>, IValidatableObject
    {
        ...
        public AccountForm(CompanyIdaccountsData data = default(CompanyIdaccountsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for AccountForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as AccountForm);
        }

        /// <summary>
        /// Returns true if AccountForm instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountForm input)
        {
            if (input == null)
                return false;
