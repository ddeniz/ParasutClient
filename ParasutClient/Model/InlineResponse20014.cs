...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(List<ShipmentDocument> data = default(List<ShipmentDocument>), List<InlineResponse20014Included> included = default(List<InlineResponse20014Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
        ...
        public List<ShipmentDocument> Data { get; set; }
