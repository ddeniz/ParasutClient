...
namespace ParasutClient.Model
{
    ...
    public partial class SalesInvoiceDetailAttributes :  IEquatable<SalesInvoiceDetailAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SalesInvoiceDetailAttributes);
        }

        /// <summary>
        /// Returns true if SalesInvoiceDetailAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceDetailAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceDetailAttributes input)
        {
            if (input == null)
                return false;
