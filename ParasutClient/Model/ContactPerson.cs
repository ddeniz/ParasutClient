...
namespace ParasutClient.Model
{
    ...
    public partial class ContactPerson :  IEquatable<ContactPerson>, IValidatableObject
    {
        ...
        public ContactPerson(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactPersonAttributes attributes = default(ContactPersonAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for ContactPerson and cannot be null");
            }
            else
            {
