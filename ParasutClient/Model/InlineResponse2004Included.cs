...
{
    /// <summary>
    /// InlineResponse2004Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004Included :  IEquatable<InlineResponse2004Included>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse2004Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse2004Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2004Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004Included input)
        {
            if (input == null)
                return false;
