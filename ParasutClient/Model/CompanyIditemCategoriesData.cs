...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIditemCategoriesData :  IEquatable<CompanyIditemCategoriesData>, IValidatableObject
    {
        ...
        public CompanyIditemCategoriesData(string id = default(string), TypeEnum? type = default(TypeEnum?), ItemCategoryAttributes attributes = default(ItemCategoryAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIditemCategoriesData);
        }

        /// <summary>
        /// Returns true if CompanyIditemCategoriesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIditemCategoriesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIditemCategoriesData input)
        {
            if (input == null)
                return false;
