...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdsalesInvoicesData :  IEquatable<CompanyIdsalesInvoicesData>, IValidatableObject
    {
        ...
        public CompanyIdsalesInvoicesData(string id = default(string), TypeEnum? type = default(TypeEnum?), SalesInvoiceAttributes attributes = default(SalesInvoiceAttributes), CompanyIdsalesInvoicesDataRelationships relationships = default(CompanyIdsalesInvoicesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public SalesInvoiceAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdsalesInvoicesData);
        }

        /// <summary>
        /// Returns true if CompanyIdsalesInvoicesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalesInvoicesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalesInvoicesData input)
        {
            if (input == null)
                return false;
