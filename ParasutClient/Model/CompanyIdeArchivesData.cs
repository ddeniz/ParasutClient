...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdeArchivesData :  IEquatable<CompanyIdeArchivesData>, IValidatableObject
    {
        ...
        public CompanyIdeArchivesData(string id = default(string), TypeEnum? type = default(TypeEnum?), EArchiveFormAttributes attributes = default(EArchiveFormAttributes), CompanyIdeArchivesDataRelationships relationships = default(CompanyIdeArchivesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public EArchiveFormAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdeArchivesData);
        }

        /// <summary>
        /// Returns true if CompanyIdeArchivesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdeArchivesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeArchivesData input)
        {
            if (input == null)
                return false;
