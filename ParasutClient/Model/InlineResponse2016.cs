...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2016 :  IEquatable<InlineResponse2016>, IValidatableObject
    {
        ...
        public InlineResponse2016(Employee data = default(Employee), List<InlineResponse2008Included> included = default(List<InlineResponse2008Included>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as InlineResponse2016);
        }

        /// <summary>
        /// Returns true if InlineResponse2016 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2016 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2016 input)
        {
            if (input == null)
                return false;
