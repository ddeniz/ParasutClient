...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentRelationshipsStockMovements :  IEquatable<ShipmentDocumentRelationshipsStockMovements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentRelationshipsStockMovements" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ShipmentDocumentRelationshipsStockMovements(List<ShipmentDocumentRelationshipsStockMovementsData> data = default(List<ShipmentDocumentRelationshipsStockMovementsData>))
        {
            this.Data = data;
        }
        ...
        public List<ShipmentDocumentRelationshipsStockMovementsData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentRelationshipsStockMovements {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentRelationshipsStockMovements);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentRelationshipsStockMovements instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentRelationshipsStockMovements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentRelationshipsStockMovements input)
        {
            if (input == null)
                return false;
