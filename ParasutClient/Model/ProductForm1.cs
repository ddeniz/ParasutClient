...
namespace ParasutClient.Model
{
    ...
    public partial class ProductForm1 :  IEquatable<ProductForm1>, IValidatableObject
    {
        ...
        public ProductForm1(CompanyIdproductsData data = default(CompanyIdproductsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ProductForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as ProductForm1);
        }

        /// <summary>
        /// Returns true if ProductForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductForm1 input)
        {
            if (input == null)
                return false;
