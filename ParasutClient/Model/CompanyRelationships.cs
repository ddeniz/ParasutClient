...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyRelationships :  IEquatable<CompanyRelationships>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyRelationships" /> class.
        /// </summary>
        /// <param name="owner">owner.</param>
        /// <param name="address">address.</param>
        public CompanyRelationships(CompanyRelationshipsOwner owner = default(CompanyRelationshipsOwner), CompanyRelationshipsAddress address = default(CompanyRelationshipsAddress))
        {
            this.Owner = owner;
        ...
        public CompanyRelationshipsOwner Owner { get; set; }

        /// <summary>
        /// Gets or Sets Address
        /// </summary>
        [DataMember(Name="address", EmitDefaultValue=false)]
        public CompanyRelationshipsAddress Address { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyRelationships {\n");
        ...
        {
            return this.Equals(input as CompanyRelationships);
        }

        /// <summary>
        /// Returns true if CompanyRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyRelationships input)
        {
            if (input == null)
                return false;
