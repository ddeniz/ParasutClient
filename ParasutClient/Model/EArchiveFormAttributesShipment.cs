...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EArchiveFormAttributesShipment :  IEquatable<EArchiveFormAttributesShipment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EArchiveFormAttributesShipment" /> class.
        /// </summary>
        ...
        public EArchiveFormAttributesShipment(string title = default(string), string vkn = default(string), string name = default(string), string tckn = default(string), string date = default(string))
        {
            this.Title = title;
            this.Vkn = vkn;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EArchiveFormAttributesShipment {\n");
        ...
        {
            return this.Equals(input as EArchiveFormAttributesShipment);
        }

        /// <summary>
        /// Returns true if EArchiveFormAttributesShipment instances are equal
        /// </summary>
        /// <param name="input">Instance of EArchiveFormAttributesShipment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EArchiveFormAttributesShipment input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Tckn == input.Tckn ||
                    (this.Tckn != null &&
                    this.Tckn.Equals(input.Tckn))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Vkn != null)
                    hashCode = hashCode * 59 + this.Vkn.GetHashCode();
                if (this.Name != null)
                    hashCode = hashCode * 59 + this.Name.GetHashCode();
                if (this.Tckn != null)
                    hashCode = hashCode * 59 + this.Tckn.GetHashCode();
                if (this.Date != null)
