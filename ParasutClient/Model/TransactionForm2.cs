...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionForm2 :  IEquatable<TransactionForm2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionForm2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionForm2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionForm2" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public TransactionForm2(CompanyIdcontactsidcontactDebitTransactionsData data = default(CompanyIdcontactsidcontactDebitTransactionsData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TransactionForm2 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionForm2 {\n");
        ...
        {
            return this.Equals(input as TransactionForm2);
        }

        /// <summary>
        /// Returns true if TransactionForm2 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionForm2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionForm2 input)
        {
            if (input == null)
                return false;
