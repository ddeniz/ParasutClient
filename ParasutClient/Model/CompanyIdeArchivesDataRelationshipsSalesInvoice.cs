...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdeArchivesDataRelationshipsSalesInvoice :  IEquatable<CompanyIdeArchivesDataRelationshipsSalesInvoice>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdeArchivesDataRelationshipsSalesInvoice);
        }

        /// <summary>
        /// Returns true if CompanyIdeArchivesDataRelationshipsSalesInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdeArchivesDataRelationshipsSalesInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdeArchivesDataRelationshipsSalesInvoice input)
        {
            if (input == null)
                return false;
