...
{
    /// <summary>
    /// CompanyRelationshipsAddressData
    /// </summary>
    [DataContract]
    public partial class CompanyRelationshipsAddressData :  IEquatable<CompanyRelationshipsAddressData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyRelationshipsAddressData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public CompanyRelationshipsAddressData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyRelationshipsAddressData {\n");
        ...
        {
            return this.Equals(input as CompanyRelationshipsAddressData);
        }

        /// <summary>
        /// Returns true if CompanyRelationshipsAddressData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyRelationshipsAddressData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyRelationshipsAddressData input)
        {
            if (input == null)
                return false;
