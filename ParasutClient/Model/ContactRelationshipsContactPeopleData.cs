...
{
    /// <summary>
    /// ContactRelationshipsContactPeopleData
    /// </summary>
    [DataContract]
    public partial class ContactRelationshipsContactPeopleData :  IEquatable<ContactRelationshipsContactPeopleData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Contactpeople for value: contact_people
            /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactRelationshipsContactPeopleData {\n");
        ...
        {
            return this.Equals(input as ContactRelationshipsContactPeopleData);
        }

        /// <summary>
        /// Returns true if ContactRelationshipsContactPeopleData instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactRelationshipsContactPeopleData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRelationshipsContactPeopleData input)
        {
            if (input == null)
                return false;
