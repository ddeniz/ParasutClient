...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsbasicData :  IEquatable<CompanyIdpurchaseBillsbasicData>, IValidatableObject
    {
        ...
        public CompanyIdpurchaseBillsbasicData(string id = default(string), TypeEnum? type = default(TypeEnum?), PurchaseBillBasicFormAttributes attributes = default(PurchaseBillBasicFormAttributes), CompanyIdpurchaseBillsbasicDataRelationships relationships = default(CompanyIdpurchaseBillsbasicDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsbasicData);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsbasicData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsbasicData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsbasicData input)
        {
            if (input == null)
                return false;
