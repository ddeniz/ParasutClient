...
namespace ParasutClient.Model
{
    ...
    public partial class TransactionForm :  IEquatable<TransactionForm>, IValidatableObject
    {
        ...
        public TransactionForm(CompanyIdaccountsiddebitTransactionsData data = default(CompanyIdaccountsiddebitTransactionsData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TransactionForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as TransactionForm);
        }

        /// <summary>
        /// Returns true if TransactionForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionForm input)
        {
            if (input == null)
                return false;
