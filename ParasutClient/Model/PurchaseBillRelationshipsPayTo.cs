...
{
    /// <summary>
    /// PurchaseBillRelationshipsPayTo
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsPayTo :  IEquatable<PurchaseBillRelationshipsPayTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsPayTo" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PurchaseBillRelationshipsPayTo(PurchaseBillRelationshipsPayToData data = default(PurchaseBillRelationshipsPayToData))
        {
            this.Data = data;
        }
        ...
        public PurchaseBillRelationshipsPayToData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsPayTo {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsPayTo);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsPayTo instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsPayTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsPayTo input)
        {
            if (input == null)
                return false;
