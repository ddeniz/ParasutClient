...
{
    /// <summary>
    /// CompanyRelationshipsOwner
    /// </summary>
    [DataContract]
    public partial class CompanyRelationshipsOwner :  IEquatable<CompanyRelationshipsOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyRelationshipsOwner" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CompanyRelationshipsOwner(CompanyRelationshipsOwnerData data = default(CompanyRelationshipsOwnerData))
        {
            this.Data = data;
        }
        ...
        public CompanyRelationshipsOwnerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyRelationshipsOwner {\n");
        ...
        {
            return this.Equals(input as CompanyRelationshipsOwner);
        }

        /// <summary>
        /// Returns true if CompanyRelationshipsOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyRelationshipsOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyRelationshipsOwner input)
        {
            if (input == null)
                return false;
