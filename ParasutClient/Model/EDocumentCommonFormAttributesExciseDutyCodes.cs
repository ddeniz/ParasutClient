...
{
    /// <summary>
    /// EDocumentCommonFormAttributesExciseDutyCodes
    /// </summary>
    [DataContract]
    public partial class EDocumentCommonFormAttributesExciseDutyCodes :  IEquatable<EDocumentCommonFormAttributesExciseDutyCodes>, IValidatableObject
    {
        /// <summary>
        /// ÖTV kodu
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EDocumentCommonFormAttributesExciseDutyCodes" /> class.
        /// </summary>
        /// <param name="product">Ürün ID.</param>
        /// <param name="salesExciseDutyCode">ÖTV kodu.</param>
        public EDocumentCommonFormAttributesExciseDutyCodes(int? product = default(int?), SalesExciseDutyCodeEnum? salesExciseDutyCode = default(SalesExciseDutyCodeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EDocumentCommonFormAttributesExciseDutyCodes {\n");
        ...
        {
            return this.Equals(input as EDocumentCommonFormAttributesExciseDutyCodes);
        }

        /// <summary>
        /// Returns true if EDocumentCommonFormAttributesExciseDutyCodes instances are equal
        /// </summary>
        /// <param name="input">Instance of EDocumentCommonFormAttributesExciseDutyCodes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentCommonFormAttributesExciseDutyCodes input)
        {
            if (input == null)
                return false;
