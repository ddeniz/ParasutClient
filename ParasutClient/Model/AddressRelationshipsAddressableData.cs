...
{
    /// <summary>
    /// AddressRelationshipsAddressableData
    /// </summary>
    [DataContract]
    public partial class AddressRelationshipsAddressableData :  IEquatable<AddressRelationshipsAddressableData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressRelationshipsAddressableData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public AddressRelationshipsAddressableData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressRelationshipsAddressableData {\n");
        ...
        {
            return this.Equals(input as AddressRelationshipsAddressableData);
        }

        /// <summary>
        /// Returns true if AddressRelationshipsAddressableData instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressRelationshipsAddressableData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressRelationshipsAddressableData input)
        {
            if (input == null)
                return false;
