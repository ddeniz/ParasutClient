...
namespace ParasutClient.Model
{
    ...
    public partial class SalaryForm :  IEquatable<SalaryForm>, IValidatableObject
    {
        ...
        public SalaryForm(CompanyIdsalariesData data = default(CompanyIdsalariesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for SalaryForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as SalaryForm);
        }

        /// <summary>
        /// Returns true if SalaryForm instances are equal
        /// </summary>
        /// <param name="input">Instance of SalaryForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalaryForm input)
        {
            if (input == null)
                return false;
