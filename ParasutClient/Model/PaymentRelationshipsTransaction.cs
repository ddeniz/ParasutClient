...
{
    /// <summary>
    /// PaymentRelationshipsTransaction
    /// </summary>
    [DataContract]
    public partial class PaymentRelationshipsTransaction :  IEquatable<PaymentRelationshipsTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRelationshipsTransaction" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PaymentRelationshipsTransaction(PaymentRelationshipsTransactionData data = default(PaymentRelationshipsTransactionData))
        {
            this.Data = data;
        }
        ...
        public PaymentRelationshipsTransactionData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRelationshipsTransaction {\n");
        ...
        {
            return this.Equals(input as PaymentRelationshipsTransaction);
        }

        /// <summary>
        /// Returns true if PaymentRelationshipsTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRelationshipsTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRelationshipsTransaction input)
        {
            if (input == null)
                return false;
