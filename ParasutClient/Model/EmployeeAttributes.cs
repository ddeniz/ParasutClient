...
namespace ParasutClient.Model
{
    ...
    public partial class EmployeeAttributes :  IEquatable<EmployeeAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EmployeeAttributes);
        }

        /// <summary>
        /// Returns true if EmployeeAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeAttributes input)
        {
            if (input == null)
                return false;
