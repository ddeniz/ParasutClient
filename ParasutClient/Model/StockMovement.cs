...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StockMovement :  IEquatable<StockMovement>, IValidatableObject
    {
        /// <summary>
        ...
        public StockMovementRelationships Relationships { get; set; }
        ...
        {
            return this.Equals(input as StockMovement);
        }

        /// <summary>
        /// Returns true if StockMovement instances are equal
        /// </summary>
        /// <param name="input">Instance of StockMovement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockMovement input)
        {
            if (input == null)
                return false;
