...
{
    /// <summary>
    /// CompanyIdshipmentDocumentsDataRelationshipsContactData
    /// </summary>
    [DataContract]
    public partial class CompanyIdshipmentDocumentsDataRelationshipsContactData :  IEquatable<CompanyIdshipmentDocumentsDataRelationshipsContactData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdshipmentDocumentsDataRelationshipsContactData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public CompanyIdshipmentDocumentsDataRelationshipsContactData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdshipmentDocumentsDataRelationshipsContactData {\n");
        ...
        {
            return this.Equals(input as CompanyIdshipmentDocumentsDataRelationshipsContactData);
        }

        /// <summary>
        /// Returns true if CompanyIdshipmentDocumentsDataRelationshipsContactData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdshipmentDocumentsDataRelationshipsContactData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdshipmentDocumentsDataRelationshipsContactData input)
        {
            if (input == null)
                return false;
