...
namespace ParasutClient.Model
{
    ...
    public partial class SalaryForm1 :  IEquatable<SalaryForm1>, IValidatableObject
    {
        ...
        public SalaryForm1(CompanyIdsalariesData data = default(CompanyIdsalariesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for SalaryForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as SalaryForm1);
        }

        /// <summary>
        /// Returns true if SalaryForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SalaryForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalaryForm1 input)
        {
            if (input == null)
                return false;
