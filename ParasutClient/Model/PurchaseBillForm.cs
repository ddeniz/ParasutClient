...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillForm :  IEquatable<PurchaseBillForm>, IValidatableObject
    {
        ...
        public PurchaseBillForm(CompanyIdpurchaseBillsbasicData data = default(CompanyIdpurchaseBillsbasicData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PurchaseBillForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PurchaseBillForm);
        }

        /// <summary>
        /// Returns true if PurchaseBillForm instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillForm input)
        {
            if (input == null)
                return false;
