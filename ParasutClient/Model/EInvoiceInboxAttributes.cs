...
namespace ParasutClient.Model
{
    ...
    public partial class EInvoiceInboxAttributes :  IEquatable<EInvoiceInboxAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EInvoiceInboxAttributes);
        }

        /// <summary>
        /// Returns true if EInvoiceInboxAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoiceInboxAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoiceInboxAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EInvoiceAddress == input.EInvoiceAddress ||
                    (this.EInvoiceAddress != null &&
                    this.EInvoiceAddress.Equals(input.EInvoiceAddress))
                ) && 
                (
                ...
                (
                    this.AddressRegisteredAt == input.AddressRegisteredAt ||
                    (this.AddressRegisteredAt != null &&
                    this.AddressRegisteredAt.Equals(input.AddressRegisteredAt))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EInvoiceAddress != null)
                    hashCode = hashCode * 59 + this.EInvoiceAddress.GetHashCode();
                if (this.Name != null)
                    hashCode = hashCode * 59 + this.Name.GetHashCode();
                if (this.InboxType != null)
                    hashCode = hashCode * 59 + this.InboxType.GetHashCode();
                if (this.AddressRegisteredAt != null)
                    hashCode = hashCode * 59 + this.AddressRegisteredAt.GetHashCode();
