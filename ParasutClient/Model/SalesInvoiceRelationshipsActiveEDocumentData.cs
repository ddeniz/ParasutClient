...
{
    /// <summary>
    /// SalesInvoiceRelationshipsActiveEDocumentData
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationshipsActiveEDocumentData :  IEquatable<SalesInvoiceRelationshipsActiveEDocumentData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Archives for value: e_archives
            /// </summary>
            [EnumMember(Value = "e_archives")]
            Archives = 1,
            
            /// <summary>
            /// Enum Invoices for value: e_invoices
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInvoiceRelationshipsActiveEDocumentData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public SalesInvoiceRelationshipsActiveEDocumentData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationshipsActiveEDocumentData {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationshipsActiveEDocumentData);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationshipsActiveEDocumentData instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationshipsActiveEDocumentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationshipsActiveEDocumentData input)
        {
            if (input == null)
                return false;
