...
namespace ParasutClient.Model
{
    ...
    public partial class ContactForm1 :  IEquatable<ContactForm1>, IValidatableObject
    {
        ...
        public ContactForm1(CompanyIdcontactsData data = default(CompanyIdcontactsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ContactForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as ContactForm1);
        }

        /// <summary>
        /// Returns true if ContactForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactForm1 input)
        {
            if (input == null)
                return false;
