...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2008Included :  IEquatable<InlineResponse2008Included>, IValidatableObject
    {
        ...
        public InlineResponse2008Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse2008Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2008Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008Included input)
        {
            if (input == null)
                return false;
