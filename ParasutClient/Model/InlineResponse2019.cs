...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2019 :  IEquatable<InlineResponse2019>, IValidatableObject
    {
        ...
        public InlineResponse2019(PurchaseBill data = default(PurchaseBill), List<InlineResponse20011Included> included = default(List<InlineResponse20011Included>))
        {
            this.Data = data;
        ...
        public PurchaseBill Data { get; set; }

        /// <summary>
        /// Gets or Sets Included
        /// </summary>
        [DataMember(Name="included", EmitDefaultValue=false)]
        public List<InlineResponse20011Included> Included { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2019);
        }

        /// <summary>
        /// Returns true if InlineResponse2019 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2019 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2019 input)
        {
            if (input == null)
                return false;
