...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentFormAttributes :  IEquatable<PaymentFormAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PaymentFormAttributes);
        }

        /// <summary>
        /// Returns true if PaymentFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFormAttributes input)
        {
            if (input == null)
                return false;
