...
{
    /// <summary>
    /// ShipmentDocumentForm1
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentForm1 :  IEquatable<ShipmentDocumentForm1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentForm1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShipmentDocumentForm1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentForm1" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public ShipmentDocumentForm1(CompanyIdshipmentDocumentsData data = default(CompanyIdshipmentDocumentsData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ShipmentDocumentForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public CompanyIdshipmentDocumentsData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentForm1 {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentForm1);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentForm1 input)
        {
            if (input == null)
                return false;
