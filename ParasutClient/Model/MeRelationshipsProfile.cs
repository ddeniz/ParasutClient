...
{
    /// <summary>
    /// MeRelationshipsProfile
    /// </summary>
    [DataContract]
    public partial class MeRelationshipsProfile :  IEquatable<MeRelationshipsProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeRelationshipsProfile" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MeRelationshipsProfile(MeRelationshipsProfileData data = default(MeRelationshipsProfileData))
        {
            this.Data = data;
        }
        ...
        public MeRelationshipsProfileData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeRelationshipsProfile {\n");
        ...
        {
            return this.Equals(input as MeRelationshipsProfile);
        }

        /// <summary>
        /// Returns true if MeRelationshipsProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of MeRelationshipsProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeRelationshipsProfile input)
        {
            if (input == null)
                return false;
