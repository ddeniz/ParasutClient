...
{
    /// <summary>
    /// MeRelationshipsProfileData
    /// </summary>
    [DataContract]
    public partial class MeRelationshipsProfileData :  IEquatable<MeRelationshipsProfileData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeRelationshipsProfileData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public MeRelationshipsProfileData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeRelationshipsProfileData {\n");
        ...
        {
            return this.Equals(input as MeRelationshipsProfileData);
        }

        /// <summary>
        /// Returns true if MeRelationshipsProfileData instances are equal
        /// </summary>
        /// <param name="input">Instance of MeRelationshipsProfileData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeRelationshipsProfileData input)
        {
            if (input == null)
                return false;
