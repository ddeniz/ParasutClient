...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemCategoryRelationshipsSubcategories :  IEquatable<ItemCategoryRelationshipsSubcategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemCategoryRelationshipsSubcategories" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ItemCategoryRelationshipsSubcategories(List<CompanyIdbankFeesDataRelationshipsCategoryData> data = default(List<CompanyIdbankFeesDataRelationshipsCategoryData>))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemCategoryRelationshipsSubcategories {\n");
        ...
        {
            return this.Equals(input as ItemCategoryRelationshipsSubcategories);
        }

        /// <summary>
        /// Returns true if ItemCategoryRelationshipsSubcategories instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemCategoryRelationshipsSubcategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemCategoryRelationshipsSubcategories input)
        {
            if (input == null)
                return false;
