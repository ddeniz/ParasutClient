...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdcontactsData :  IEquatable<CompanyIdcontactsData>, IValidatableObject
    {
        ...
        public CompanyIdcontactsData(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactAttributes attributes = default(ContactAttributes), CompanyIdcontactsDataRelationships relationships = default(CompanyIdcontactsDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdcontactsData);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdcontactsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsData input)
        {
            if (input == null)
                return false;
