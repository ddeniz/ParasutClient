...
{
    /// <summary>
    /// StockMovementRelationshipsSource
    /// </summary>
    [DataContract]
    public partial class StockMovementRelationshipsSource :  IEquatable<StockMovementRelationshipsSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StockMovementRelationshipsSource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public StockMovementRelationshipsSource(StockMovementRelationshipsSourceData data = default(StockMovementRelationshipsSourceData))
        {
            this.Data = data;
        }
        ...
        public StockMovementRelationshipsSourceData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StockMovementRelationshipsSource {\n");
        ...
        {
            return this.Equals(input as StockMovementRelationshipsSource);
        }

        /// <summary>
        /// Returns true if StockMovementRelationshipsSource instances are equal
        /// </summary>
        /// <param name="input">Instance of StockMovementRelationshipsSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockMovementRelationshipsSource input)
        {
            if (input == null)
                return false;
