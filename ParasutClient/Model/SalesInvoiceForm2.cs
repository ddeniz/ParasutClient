...
namespace ParasutClient.Model
{
    ...
    public partial class SalesInvoiceForm2 :  IEquatable<SalesInvoiceForm2>, IValidatableObject
    {
        ...
        public SalesInvoiceForm2(CompanyIdsalesInvoicesData data = default(CompanyIdsalesInvoicesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for SalesInvoiceForm2 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as SalesInvoiceForm2);
        }

        /// <summary>
        /// Returns true if SalesInvoiceForm2 instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceForm2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceForm2 input)
        {
            if (input == null)
                return false;
