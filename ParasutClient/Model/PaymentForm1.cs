...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentForm1 :  IEquatable<PaymentForm1>, IValidatableObject
    {
        ...
        public PaymentForm1(CompanyIdbankFeesidpaymentsData data = default(CompanyIdbankFeesidpaymentsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PaymentForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PaymentForm1);
        }

        /// <summary>
        /// Returns true if PaymentForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentForm1 input)
        {
            if (input == null)
                return false;
