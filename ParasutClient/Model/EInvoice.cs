...
namespace ParasutClient.Model
{
    ...
    public partial class EInvoice :  IEquatable<EInvoice>, IValidatableObject
    {
        ...
        public EInvoice(string id = default(string), TypeEnum? type = default(TypeEnum?), EInvoiceAttributes attributes = default(EInvoiceAttributes), EInvoiceRelationships relationships = default(EInvoiceRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for EInvoice and cannot be null");
            }
            else
            {
        ...
        public EInvoiceAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public EInvoiceRelationships Relationships { get; set; }
        ...
        {
            return this.Equals(input as EInvoice);
        }

        /// <summary>
        /// Returns true if EInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoice input)
        {
            if (input == null)
                return false;
