...
{
    /// <summary>
    /// PaymentRelationshipsPayable
    /// </summary>
    [DataContract]
    public partial class PaymentRelationshipsPayable :  IEquatable<PaymentRelationshipsPayable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRelationshipsPayable" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PaymentRelationshipsPayable(PaymentRelationshipsPayableData data = default(PaymentRelationshipsPayableData))
        {
            this.Data = data;
        }
        ...
        public PaymentRelationshipsPayableData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRelationshipsPayable {\n");
        ...
        {
            return this.Equals(input as PaymentRelationshipsPayable);
        }

        /// <summary>
        /// Returns true if PaymentRelationshipsPayable instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRelationshipsPayable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRelationshipsPayable input)
        {
            if (input == null)
                return false;
