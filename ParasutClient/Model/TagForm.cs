...
namespace ParasutClient.Model
{
    ...
    public partial class TagForm :  IEquatable<TagForm>, IValidatableObject
    {
        ...
        public TagForm(CompanyIdtagsData data = default(CompanyIdtagsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TagForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as TagForm);
        }

        /// <summary>
        /// Returns true if TagForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TagForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagForm input)
        {
            if (input == null)
                return false;
