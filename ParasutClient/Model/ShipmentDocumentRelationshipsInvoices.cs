...
{
    /// <summary>
    /// ShipmentDocumentRelationshipsInvoices
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentRelationshipsInvoices :  IEquatable<ShipmentDocumentRelationshipsInvoices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentRelationshipsInvoices" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ShipmentDocumentRelationshipsInvoices(List<EInvoiceRelationshipsInvoiceData> data = default(List<EInvoiceRelationshipsInvoiceData>))
        {
            this.Data = data;
        }
        ...
        public List<EInvoiceRelationshipsInvoiceData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentRelationshipsInvoices {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentRelationshipsInvoices);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentRelationshipsInvoices instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentRelationshipsInvoices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentRelationshipsInvoices input)
        {
            if (input == null)
                return false;
