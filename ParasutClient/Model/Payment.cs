...
namespace ParasutClient.Model
{
    ...
    public partial class Payment :  IEquatable<Payment>, IValidatableObject
    {
        ...
        public Payment(string id = default(string), TypeEnum? type = default(TypeEnum?), PaymentAttributes attributes = default(PaymentAttributes), PaymentRelationships relationships = default(PaymentRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Payment and cannot be null");
            }
            else
            {
        ...
        public PaymentRelationships Relationships { get; set; }
