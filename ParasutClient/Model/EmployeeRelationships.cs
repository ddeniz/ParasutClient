...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmployeeRelationships :  IEquatable<EmployeeRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyRelationshipsOwner ManagedByUser { get; set; }

        /// <summary>
        /// Gets or Sets ManagedByUserRole
        /// </summary>
        [DataMember(Name="managed_by_user_role", EmitDefaultValue=false)]
        public EmployeeRelationshipsManagedByUserRole ManagedByUserRole { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmployeeRelationships {\n");
        ...
        {
            return this.Equals(input as EmployeeRelationships);
        }

        /// <summary>
        /// Returns true if EmployeeRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ManagedByUser == input.ManagedByUser ||
                    (this.ManagedByUser != null &&
                    this.ManagedByUser.Equals(input.ManagedByUser))
                ) && 
                (
                    this.ManagedByUserRole == input.ManagedByUserRole ||
                    (this.ManagedByUserRole != null &&
                    this.ManagedByUserRole.Equals(input.ManagedByUserRole))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ManagedByUser != null)
                    hashCode = hashCode * 59 + this.ManagedByUser.GetHashCode();
                if (this.ManagedByUserRole != null)
                    hashCode = hashCode * 59 + this.ManagedByUserRole.GetHashCode();
                return hashCode;
            }
        }
