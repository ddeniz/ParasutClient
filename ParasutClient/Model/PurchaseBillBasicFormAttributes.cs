...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillBasicFormAttributes :  IEquatable<PurchaseBillBasicFormAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PurchaseBillBasicFormAttributes);
        }

        /// <summary>
        /// Returns true if PurchaseBillBasicFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillBasicFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillBasicFormAttributes input)
        {
            if (input == null)
                return false;
