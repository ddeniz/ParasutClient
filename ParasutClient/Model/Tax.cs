...
namespace ParasutClient.Model
{
    ...
    public partial class Tax :  IEquatable<Tax>, IValidatableObject
    {
        ...
        public Tax(string id = default(string), TypeEnum? type = default(TypeEnum?), TaxAttributes attributes = default(TaxAttributes), CompanyIdbankFeesDataRelationships relationships = default(CompanyIdbankFeesDataRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Tax and cannot be null");
            }
            else
            {
