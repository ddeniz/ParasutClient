...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesOffer :  IEquatable<SalesOffer>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesOffer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SalesOffer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesOffer" /> class.
        /// </summary>
        ...
        public SalesOffer(string id = default(string), TypeEnum? type = default(TypeEnum?), SalesOfferAttributes attributes = default(SalesOfferAttributes), CompanyIdeArchivesDataRelationships relationships = default(CompanyIdeArchivesDataRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for SalesOffer and cannot be null");
            }
            else
            {
        ...
        public SalesOfferAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as SalesOffer);
        }

        /// <summary>
        /// Returns true if SalesOffer instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesOffer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesOffer input)
        {
            if (input == null)
                return false;
