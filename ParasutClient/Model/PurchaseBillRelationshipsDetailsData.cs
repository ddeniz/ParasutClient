...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsDetailsData :  IEquatable<PurchaseBillRelationshipsDetailsData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsDetailsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PurchaseBillRelationshipsDetailsData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsDetailsData {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsDetailsData);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsDetailsData instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsDetailsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsDetailsData input)
        {
            if (input == null)
                return false;
