...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2012Included :  IEquatable<InlineResponse2012Included>, IValidatableObject
    {
        ...
        public InlineResponse2012Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse2012Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2012Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2012Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2012Included input)
        {
            if (input == null)
                return false;
