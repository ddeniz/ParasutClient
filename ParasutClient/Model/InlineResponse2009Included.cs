...
{
    /// <summary>
    /// InlineResponse2009Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009Included :  IEquatable<InlineResponse2009Included>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse2009Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse2009Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2009Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009Included input)
        {
            if (input == null)
                return false;
