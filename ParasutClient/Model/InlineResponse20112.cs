...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20112 :  IEquatable<InlineResponse20112>, IValidatableObject
    {
        ...
        public InlineResponse20112(ShipmentDocument data = default(ShipmentDocument), List<InlineResponse20014Included> included = default(List<InlineResponse20014Included>))
        {
            this.Data = data;
        ...
        public ShipmentDocument Data { get; set; }

        /// <summary>
        /// Gets or Sets Included
        /// </summary>
        [DataMember(Name="included", EmitDefaultValue=false)]
        public List<InlineResponse20014Included> Included { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20112);
        }

        /// <summary>
        /// Returns true if InlineResponse20112 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20112 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20112 input)
        {
            if (input == null)
                return false;
