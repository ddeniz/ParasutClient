...
{
    /// <summary>
    /// PurchaseBillRelationshipsActiveEDocument
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsActiveEDocument :  IEquatable<PurchaseBillRelationshipsActiveEDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsActiveEDocument" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PurchaseBillRelationshipsActiveEDocument(PurchaseBillRelationshipsActiveEDocumentData data = default(PurchaseBillRelationshipsActiveEDocumentData))
        {
            this.Data = data;
        }
        ...
        public PurchaseBillRelationshipsActiveEDocumentData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsActiveEDocument {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsActiveEDocument);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsActiveEDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsActiveEDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsActiveEDocument input)
        {
            if (input == null)
                return false;
