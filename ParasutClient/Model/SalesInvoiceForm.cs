...
namespace ParasutClient.Model
{
    ...
    public partial class SalesInvoiceForm :  IEquatable<SalesInvoiceForm>, IValidatableObject
    {
        ...
        public SalesInvoiceForm(CompanyIdsalesInvoicesData data = default(CompanyIdsalesInvoicesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for SalesInvoiceForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as SalesInvoiceForm);
        }

        /// <summary>
        /// Returns true if SalesInvoiceForm instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceForm input)
        {
            if (input == null)
                return false;
