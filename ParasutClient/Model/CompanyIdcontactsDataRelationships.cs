...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdcontactsDataRelationships :  IEquatable<CompanyIdcontactsDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdcontactsDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdcontactsDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsDataRelationships input)
        {
            if (input == null)
                return false;
