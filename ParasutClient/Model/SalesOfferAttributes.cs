...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesOfferAttributes :  IEquatable<SalesOfferAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesOfferAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SalesOfferAttributes()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesOfferAttributes {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SalesOfferAttributes);
        }

        /// <summary>
        /// Returns true if SalesOfferAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesOfferAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesOfferAttributes input)
        {
            if (input == null)
                return false;
