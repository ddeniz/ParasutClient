...
{
    /// <summary>
    /// CompanyIdshipmentDocumentsDataRelationshipsStockMovements
    /// </summary>
    [DataContract]
    public partial class CompanyIdshipmentDocumentsDataRelationshipsStockMovements :  IEquatable<CompanyIdshipmentDocumentsDataRelationshipsStockMovements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdshipmentDocumentsDataRelationshipsStockMovements" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CompanyIdshipmentDocumentsDataRelationshipsStockMovements(List<CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData> data = default(List<CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData>))
        {
            this.Data = data;
        }
        ...
        public List<CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdshipmentDocumentsDataRelationshipsStockMovements {\n");
        ...
        {
            return this.Equals(input as CompanyIdshipmentDocumentsDataRelationshipsStockMovements);
        }

        /// <summary>
        /// Returns true if CompanyIdshipmentDocumentsDataRelationshipsStockMovements instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdshipmentDocumentsDataRelationshipsStockMovements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdshipmentDocumentsDataRelationshipsStockMovements input)
        {
            if (input == null)
                return false;
