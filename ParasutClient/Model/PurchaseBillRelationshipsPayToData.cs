...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsPayToData :  IEquatable<PurchaseBillRelationshipsPayToData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsPayToData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PurchaseBillRelationshipsPayToData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsPayToData {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsPayToData);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsPayToData instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsPayToData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsPayToData input)
        {
            if (input == null)
                return false;
