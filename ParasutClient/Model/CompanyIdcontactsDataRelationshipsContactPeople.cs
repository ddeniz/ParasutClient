...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdcontactsDataRelationshipsContactPeople :  IEquatable<CompanyIdcontactsDataRelationshipsContactPeople>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdcontactsDataRelationshipsContactPeople);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsDataRelationshipsContactPeople instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdcontactsDataRelationshipsContactPeople to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsDataRelationshipsContactPeople input)
        {
            if (input == null)
                return false;
