...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2017 :  IEquatable<InlineResponse2017>, IValidatableObject
    {
        ...
        public InlineResponse2017(ItemCategory data = default(ItemCategory), List<InlineResponse2009Included> included = default(List<InlineResponse2009Included>))
        {
            this.Data = data;
        ...
        public List<InlineResponse2009Included> Included { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2017);
        }

        /// <summary>
        /// Returns true if InlineResponse2017 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2017 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2017 input)
        {
            if (input == null)
                return false;
