...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EArchiveFormAttributesInternetSale :  IEquatable<EArchiveFormAttributesInternetSale>, IValidatableObject
    {
        /// <summary>
        /// Ödeme tipi
        /// </summary>
        ...
        public enum PaymentTypeEnum
        {
            ...
            /// <summary>
            /// Enum KREDIKARTIBANKAKARTI for value: KREDIKARTI/BANKAKARTI
            /// </summary>
            [EnumMember(Value = "KREDIKARTI/BANKAKARTI")]
            KREDIKARTIBANKAKARTI = 1,
            
            /// <summary>
            /// Enum EFTHAVALE for value: EFT/HAVALE
            /// </summary>
            [EnumMember(Value = "EFT/HAVALE")]
            EFTHAVALE = 2,
            
            /// <summary>
            /// Enum KAPIDAODEME for value: KAPIDAODEME
            /// </summary>
            [EnumMember(Value = "KAPIDAODEME")]
            KAPIDAODEME = 3,
            
            /// <summary>
            /// Enum ODEMEARACISI for value: ODEMEARACISI
            /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EArchiveFormAttributesInternetSale {\n");
        ...
        {
            return this.Equals(input as EArchiveFormAttributesInternetSale);
        }

        /// <summary>
        /// Returns true if EArchiveFormAttributesInternetSale instances are equal
        /// </summary>
        /// <param name="input">Instance of EArchiveFormAttributesInternetSale to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EArchiveFormAttributesInternetSale input)
        {
            if (input == null)
                return false;
