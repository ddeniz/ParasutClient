...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2012 :  IEquatable<InlineResponse2012>, IValidatableObject
    {
        ...
        public InlineResponse2012(BankFee data = default(BankFee), List<InlineResponse2012Included> included = default(List<InlineResponse2012Included>))
        {
            this.Data = data;
