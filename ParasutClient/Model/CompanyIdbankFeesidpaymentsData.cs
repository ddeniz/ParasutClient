...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesidpaymentsData :  IEquatable<CompanyIdbankFeesidpaymentsData>, IValidatableObject
    {
        ...
        public PaymentFormAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdbankFeesidpaymentsData);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesidpaymentsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesidpaymentsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesidpaymentsData input)
        {
            if (input == null)
                return false;
