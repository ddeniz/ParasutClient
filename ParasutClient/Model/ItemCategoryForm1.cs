...
namespace ParasutClient.Model
{
    ...
    public partial class ItemCategoryForm1 :  IEquatable<ItemCategoryForm1>, IValidatableObject
    {
        ...
        public ItemCategoryForm1(CompanyIditemCategoriesData data = default(CompanyIditemCategoriesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ItemCategoryForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as ItemCategoryForm1);
        }

        /// <summary>
        /// Returns true if ItemCategoryForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemCategoryForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemCategoryForm1 input)
        {
            if (input == null)
                return false;
