...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships input)
        {
            if (input == null)
                return false;
