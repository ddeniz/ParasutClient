...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(List<PurchaseBill> data = default(List<PurchaseBill>), List<InlineResponse20011Included> included = default(List<InlineResponse20011Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
        ...
        public List<PurchaseBill> Data { get; set; }
