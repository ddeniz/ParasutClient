...
namespace ParasutClient.Model
{
    ...
    public partial class ContactForm :  IEquatable<ContactForm>, IValidatableObject
    {
        ...
        public ContactForm(CompanyIdcontactsData data = default(CompanyIdcontactsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ContactForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as ContactForm);
        }

        /// <summary>
        /// Returns true if ContactForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactForm input)
        {
            if (input == null)
                return false;
