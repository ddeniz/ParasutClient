...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionForm3 :  IEquatable<TransactionForm3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionForm3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionForm3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionForm3" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        public TransactionForm3(CompanyIdcontactsidcontactCreditTransactionsData data = default(CompanyIdcontactsidcontactCreditTransactionsData))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TransactionForm3 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionForm3 {\n");
        ...
        {
            return this.Equals(input as TransactionForm3);
        }

        /// <summary>
        /// Returns true if TransactionForm3 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionForm3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionForm3 input)
        {
            if (input == null)
                return false;
