...
namespace ParasutClient.Model
{
    ...
    public partial class EDocumentCommonFormAttributes :  IEquatable<EDocumentCommonFormAttributes>, IValidatableObject
    {
        ...
        public EDocumentCommonFormAttributes(string vatWithholdingCode = default(string), string vatExemptionReasonCode = default(string), string vatExemptionReason = default(string), string note = default(string), List<EDocumentCommonFormAttributesExciseDutyCodes> exciseDutyCodes = default(List<EDocumentCommonFormAttributesExciseDutyCodes>))
        {
        ...
        public List<EDocumentCommonFormAttributesExciseDutyCodes> ExciseDutyCodes { get; set; }
        ...
        {
            return this.Equals(input as EDocumentCommonFormAttributes);
        }

        /// <summary>
        /// Returns true if EDocumentCommonFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EDocumentCommonFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentCommonFormAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.VatWithholdingCode == input.VatWithholdingCode ||
                    (this.VatWithholdingCode != null &&
                    this.VatWithholdingCode.Equals(input.VatWithholdingCode))
                ) && 
                (
                    this.VatExemptionReasonCode == input.VatExemptionReasonCode ||
                    (this.VatExemptionReasonCode != null &&
                    this.VatExemptionReasonCode.Equals(input.VatExemptionReasonCode))
                ) && 
                (
                    this.VatExemptionReason == input.VatExemptionReason ||
                    (this.VatExemptionReason != null &&
                    this.VatExemptionReason.Equals(input.VatExemptionReason))
                ) && 
                (
                ...
                (
                    this.ExciseDutyCodes == input.ExciseDutyCodes ||
                    this.ExciseDutyCodes != null &&
                    this.ExciseDutyCodes.SequenceEqual(input.ExciseDutyCodes)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VatWithholdingCode != null)
                    hashCode = hashCode * 59 + this.VatWithholdingCode.GetHashCode();
                if (this.VatExemptionReasonCode != null)
                    hashCode = hashCode * 59 + this.VatExemptionReasonCode.GetHashCode();
                if (this.VatExemptionReason != null)
                    hashCode = hashCode * 59 + this.VatExemptionReason.GetHashCode();
                if (this.Note != null)
                    hashCode = hashCode * 59 + this.Note.GetHashCode();
                if (this.ExciseDutyCodes != null)
                    hashCode = hashCode * 59 + this.ExciseDutyCodes.GetHashCode();
                return hashCode;
            }
        }
