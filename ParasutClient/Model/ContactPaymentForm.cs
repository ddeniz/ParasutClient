...
namespace ParasutClient.Model
{
    ...
    public partial class ContactPaymentForm :  IEquatable<ContactPaymentForm>, IValidatableObject
    {
        ...
        public ContactPaymentForm(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactPaymentFormAttributes attributes = default(ContactPaymentFormAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for ContactPaymentForm and cannot be null");
            }
            else
            {
        ...
        public ContactPaymentFormAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as ContactPaymentForm);
        }

        /// <summary>
        /// Returns true if ContactPaymentForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactPaymentForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactPaymentForm input)
        {
            if (input == null)
                return false;
