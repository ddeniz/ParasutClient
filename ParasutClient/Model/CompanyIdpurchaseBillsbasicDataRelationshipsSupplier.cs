...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsbasicDataRelationshipsSupplier :  IEquatable<CompanyIdpurchaseBillsbasicDataRelationshipsSupplier>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsbasicDataRelationshipsSupplier);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsbasicDataRelationshipsSupplier instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsbasicDataRelationshipsSupplier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsbasicDataRelationshipsSupplier input)
        {
            if (input == null)
                return false;
