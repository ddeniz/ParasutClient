...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesDataRelationshipsTagsData :  IEquatable<CompanyIdbankFeesDataRelationshipsTagsData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdbankFeesDataRelationshipsTagsData);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesDataRelationshipsTagsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesDataRelationshipsTagsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesDataRelationshipsTagsData input)
        {
            if (input == null)
                return false;
