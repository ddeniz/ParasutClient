...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesData :  IEquatable<CompanyIdbankFeesData>, IValidatableObject
    {
        ...
        public CompanyIdbankFeesData(string id = default(string), TypeEnum? type = default(TypeEnum?), BankFeeAttributes attributes = default(BankFeeAttributes), CompanyIdbankFeesDataRelationships relationships = default(CompanyIdbankFeesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdbankFeesData);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesData input)
        {
            if (input == null)
                return false;
