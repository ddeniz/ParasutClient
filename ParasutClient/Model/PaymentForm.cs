...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentForm :  IEquatable<PaymentForm>, IValidatableObject
    {
        ...
        public PaymentForm(CompanyIdbankFeesidpaymentsData data = default(CompanyIdbankFeesidpaymentsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PaymentForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PaymentForm);
        }

        /// <summary>
        /// Returns true if PaymentForm instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentForm input)
        {
            if (input == null)
                return false;
