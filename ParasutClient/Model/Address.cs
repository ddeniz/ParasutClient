...
namespace ParasutClient.Model
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        public Address(string id = default(string), TypeEnum? type = default(TypeEnum?), AddressAttributes attributes = default(AddressAttributes), AddressRelationships relationships = default(AddressRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Address and cannot be null");
            }
            else
            {
