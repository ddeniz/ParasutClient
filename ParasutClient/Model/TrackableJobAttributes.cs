...
namespace ParasutClient.Model
{
    ...
    public partial class TrackableJobAttributes :  IEquatable<TrackableJobAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrackableJobAttributes);
        }

        /// <summary>
        /// Returns true if TrackableJobAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackableJobAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackableJobAttributes input)
        {
            if (input == null)
                return false;
