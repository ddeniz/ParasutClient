...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillForm3 :  IEquatable<PurchaseBillForm3>, IValidatableObject
    {
        ...
        public PurchaseBillForm3(CompanyIdpurchaseBillsdetailedData data = default(CompanyIdpurchaseBillsdetailedData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PurchaseBillForm3 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PurchaseBillForm3);
        }

        /// <summary>
        /// Returns true if PurchaseBillForm3 instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillForm3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillForm3 input)
        {
            if (input == null)
                return false;
