...
namespace ParasutClient.Model
{
    ...
    public partial class SalesInvoice :  IEquatable<SalesInvoice>, IValidatableObject
    {
        ...
        public SalesInvoice(string id = default(string), TypeEnum? type = default(TypeEnum?), SalesInvoiceAttributes attributes = default(SalesInvoiceAttributes), SalesInvoiceRelationships relationships = default(SalesInvoiceRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for SalesInvoice and cannot be null");
            }
            else
            {
        ...
        public SalesInvoiceRelationships Relationships { get; set; }
