...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsRecurrencePlan :  IEquatable<PurchaseBillRelationshipsRecurrencePlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsRecurrencePlan" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PurchaseBillRelationshipsRecurrencePlan(PurchaseBillRelationshipsRecurrencePlanData data = default(PurchaseBillRelationshipsRecurrencePlanData))
        {
            this.Data = data;
        }
        ...
        public PurchaseBillRelationshipsRecurrencePlanData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsRecurrencePlan {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsRecurrencePlan);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsRecurrencePlan instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsRecurrencePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsRecurrencePlan input)
        {
            if (input == null)
                return false;
