...
{
    /// <summary>
    /// TransactionRelationshipsDebitAccountData
    /// </summary>
    [DataContract]
    public partial class TransactionRelationshipsDebitAccountData :  IEquatable<TransactionRelationshipsDebitAccountData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRelationshipsDebitAccountData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public TransactionRelationshipsDebitAccountData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionRelationshipsDebitAccountData {\n");
        ...
        {
            return this.Equals(input as TransactionRelationshipsDebitAccountData);
        }

        /// <summary>
        /// Returns true if TransactionRelationshipsDebitAccountData instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRelationshipsDebitAccountData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRelationshipsDebitAccountData input)
        {
            if (input == null)
                return false;
