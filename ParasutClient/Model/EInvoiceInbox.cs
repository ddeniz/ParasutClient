...
namespace ParasutClient.Model
{
    ...
    public partial class EInvoiceInbox :  IEquatable<EInvoiceInbox>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Einvoiceinboxes for value: e_invoice_inboxes
            /// </summary>
        ...
        public EInvoiceInbox(string id = default(string), TypeEnum? type = default(TypeEnum?), EInvoiceInboxAttributes attributes = default(EInvoiceInboxAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for EInvoiceInbox and cannot be null");
            }
            else
            {
        ...
        public EInvoiceInboxAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as EInvoiceInbox);
        }

        /// <summary>
        /// Returns true if EInvoiceInbox instances are equal
        /// </summary>
        /// <param name="input">Instance of EInvoiceInbox to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoiceInbox input)
        {
            if (input == null)
                return false;
