...
{
    /// <summary>
    /// AddressRelationshipsAddressable
    /// </summary>
    [DataContract]
    public partial class AddressRelationshipsAddressable :  IEquatable<AddressRelationshipsAddressable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressRelationshipsAddressable" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public AddressRelationshipsAddressable(AddressRelationshipsAddressableData data = default(AddressRelationshipsAddressableData))
        {
            this.Data = data;
        }
        ...
        public AddressRelationshipsAddressableData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressRelationshipsAddressable {\n");
        ...
        {
            return this.Equals(input as AddressRelationshipsAddressable);
        }

        /// <summary>
        /// Returns true if AddressRelationshipsAddressable instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressRelationshipsAddressable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressRelationshipsAddressable input)
        {
            if (input == null)
                return false;
