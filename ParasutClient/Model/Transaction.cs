...
namespace ParasutClient.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>, IValidatableObject
    {
        ...
        public Transaction(string id = default(string), TypeEnum? type = default(TypeEnum?), TransactionAttributes attributes = default(TransactionAttributes), TransactionRelationships relationships = default(TransactionRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Transaction and cannot be null");
            }
            else
            {
