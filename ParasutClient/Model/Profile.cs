...
namespace ParasutClient.Model
{
    ...
    public partial class Profile :  IEquatable<Profile>, IValidatableObject
    {
        ...
        public Profile(string id = default(string), TypeEnum? type = default(TypeEnum?), ProfileAttributes attributes = default(ProfileAttributes), ProfileRelationships relationships = default(ProfileRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Profile and cannot be null");
            }
            else
            {
