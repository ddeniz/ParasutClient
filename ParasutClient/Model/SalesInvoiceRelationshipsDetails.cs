...
{
    /// <summary>
    /// SalesInvoiceRelationshipsDetails
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationshipsDetails :  IEquatable<SalesInvoiceRelationshipsDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInvoiceRelationshipsDetails" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public SalesInvoiceRelationshipsDetails(List<SalesInvoiceRelationshipsDetailsData> data = default(List<SalesInvoiceRelationshipsDetailsData>))
        {
            this.Data = data;
        }
        ...
        public List<SalesInvoiceRelationshipsDetailsData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationshipsDetails {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationshipsDetails);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationshipsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationshipsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationshipsDetails input)
        {
            if (input == null)
                return false;
