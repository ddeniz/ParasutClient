...
{
    /// <summary>
    /// CompanyRelationshipsOwnerData
    /// </summary>
    [DataContract]
    public partial class CompanyRelationshipsOwnerData :  IEquatable<CompanyRelationshipsOwnerData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyRelationshipsOwnerData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public CompanyRelationshipsOwnerData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyRelationshipsOwnerData {\n");
        ...
        {
            return this.Equals(input as CompanyRelationshipsOwnerData);
        }

        /// <summary>
        /// Returns true if CompanyRelationshipsOwnerData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyRelationshipsOwnerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyRelationshipsOwnerData input)
        {
            if (input == null)
                return false;
