...
namespace ParasutClient.Model
{
    ...
    public partial class UserRole :  IEquatable<UserRole>, IValidatableObject
    {
        ...
        public UserRole(string id = default(string), TypeEnum? type = default(TypeEnum?), UserRoleAttributes attributes = default(UserRoleAttributes), UserRoleRelationships relationships = default(UserRoleRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for UserRole and cannot be null");
            }
            else
            {
        ...
        public UserRoleAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public UserRoleRelationships Relationships { get; set; }
