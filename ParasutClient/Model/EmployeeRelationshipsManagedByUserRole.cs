...
{
    /// <summary>
    /// EmployeeRelationshipsManagedByUserRole
    /// </summary>
    [DataContract]
    public partial class EmployeeRelationshipsManagedByUserRole :  IEquatable<EmployeeRelationshipsManagedByUserRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeRelationshipsManagedByUserRole" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EmployeeRelationshipsManagedByUserRole(EmployeeRelationshipsManagedByUserRoleData data = default(EmployeeRelationshipsManagedByUserRoleData))
        {
            this.Data = data;
        }
        ...
        public EmployeeRelationshipsManagedByUserRoleData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmployeeRelationshipsManagedByUserRole {\n");
        ...
        {
            return this.Equals(input as EmployeeRelationshipsManagedByUserRole);
        }

        /// <summary>
        /// Returns true if EmployeeRelationshipsManagedByUserRole instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeRelationshipsManagedByUserRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeRelationshipsManagedByUserRole input)
        {
            if (input == null)
                return false;
