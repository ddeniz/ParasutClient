...
namespace ParasutClient.Model
{
    ...
    public partial class BankFeeAttributes :  IEquatable<BankFeeAttributes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as BankFeeAttributes);
        }

        /// <summary>
        /// Returns true if BankFeeAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of BankFeeAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankFeeAttributes input)
        {
            if (input == null)
                return false;
