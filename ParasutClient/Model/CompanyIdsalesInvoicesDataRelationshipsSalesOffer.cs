...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyIdsalesInvoicesDataRelationshipsSalesOffer :  IEquatable<CompanyIdsalesInvoicesDataRelationshipsSalesOffer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdsalesInvoicesDataRelationshipsSalesOffer" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CompanyIdsalesInvoicesDataRelationshipsSalesOffer(CompanyIdsalesInvoicesDataRelationshipsSalesOfferData data = default(CompanyIdsalesInvoicesDataRelationshipsSalesOfferData))
        {
            this.Data = data;
        }
        ...
        public CompanyIdsalesInvoicesDataRelationshipsSalesOfferData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdsalesInvoicesDataRelationshipsSalesOffer {\n");
        ...
        {
            return this.Equals(input as CompanyIdsalesInvoicesDataRelationshipsSalesOffer);
        }

        /// <summary>
        /// Returns true if CompanyIdsalesInvoicesDataRelationshipsSalesOffer instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalesInvoicesDataRelationshipsSalesOffer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalesInvoicesDataRelationshipsSalesOffer input)
        {
            if (input == null)
                return false;
