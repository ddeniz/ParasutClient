...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee :  IEquatable<CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee input)
        {
            if (input == null)
                return false;
