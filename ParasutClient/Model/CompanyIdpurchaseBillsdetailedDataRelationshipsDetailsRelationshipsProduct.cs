...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct input)
        {
            if (input == null)
                return false;
