...
namespace ParasutClient.Model
{
    ...
    public partial class TransactionRelationships :  IEquatable<TransactionRelationships>, IValidatableObject
    {
        ...
        public TransactionRelationshipsDebitAccount DebitAccount { get; set; }

        /// <summary>
        /// Gets or Sets CreditAccount
        /// </summary>
        [DataMember(Name="credit_account", EmitDefaultValue=false)]
        public TransactionRelationshipsDebitAccount CreditAccount { get; set; }
        ...
        {
            return this.Equals(input as TransactionRelationships);
        }

        /// <summary>
        /// Returns true if TransactionRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRelationships input)
        {
            if (input == null)
                return false;
