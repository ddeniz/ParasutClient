...
{
    /// <summary>
    /// TransactionRelationshipsDebitAccount
    /// </summary>
    [DataContract]
    public partial class TransactionRelationshipsDebitAccount :  IEquatable<TransactionRelationshipsDebitAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRelationshipsDebitAccount" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TransactionRelationshipsDebitAccount(TransactionRelationshipsDebitAccountData data = default(TransactionRelationshipsDebitAccountData))
        {
            this.Data = data;
        }
        ...
        public TransactionRelationshipsDebitAccountData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionRelationshipsDebitAccount {\n");
        ...
        {
            return this.Equals(input as TransactionRelationshipsDebitAccount);
        }

        /// <summary>
        /// Returns true if TransactionRelationshipsDebitAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRelationshipsDebitAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRelationshipsDebitAccount input)
        {
            if (input == null)
                return false;
