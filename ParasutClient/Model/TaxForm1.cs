...
namespace ParasutClient.Model
{
    ...
    public partial class TaxForm1 :  IEquatable<TaxForm1>, IValidatableObject
    {
        ...
        public TaxForm1(CompanyIdtaxesData data = default(CompanyIdtaxesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TaxForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as TaxForm1);
        }

        /// <summary>
        /// Returns true if TaxForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxForm1 input)
        {
            if (input == null)
                return false;
