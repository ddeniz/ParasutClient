...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationshipsSharings :  IEquatable<SalesInvoiceRelationshipsSharings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInvoiceRelationshipsSharings" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public SalesInvoiceRelationshipsSharings(List<SalesInvoiceRelationshipsSharingsData> data = default(List<SalesInvoiceRelationshipsSharingsData>))
        {
            this.Data = data;
        }
        ...
        public List<SalesInvoiceRelationshipsSharingsData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationshipsSharings {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationshipsSharings);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationshipsSharings instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationshipsSharings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationshipsSharings input)
        {
            if (input == null)
                return false;
