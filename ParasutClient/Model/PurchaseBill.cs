...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBill :  IEquatable<PurchaseBill>, IValidatableObject
    {
        ...
        public PurchaseBill(string id = default(string), TypeEnum? type = default(TypeEnum?), PurchaseBillAttributes attributes = default(PurchaseBillAttributes), PurchaseBillRelationships relationships = default(PurchaseBillRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for PurchaseBill and cannot be null");
            }
            else
            {
        ...
        public PurchaseBillAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public PurchaseBillRelationships Relationships { get; set; }
        ...
        {
            return this.Equals(input as PurchaseBill);
        }

        /// <summary>
        /// Returns true if PurchaseBill instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBill to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBill input)
        {
            if (input == null)
                return false;
