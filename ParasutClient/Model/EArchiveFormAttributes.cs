...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EArchiveFormAttributes : EDocumentCommonFormAttributes,  IEquatable<EArchiveFormAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public EArchiveFormAttributes(EArchiveFormAttributesInternetSale internetSale = default(EArchiveFormAttributesInternetSale), EArchiveFormAttributesShipment shipment = default(EArchiveFormAttributesShipment), string vatWithholdingCode = default(string), string vatExemptionReasonCode = default(string), string vatExemptionReason = default(string), string note = default(string), List<EDocumentCommonFormAttributesExciseDutyCodes> exciseDutyCodes = default(List<EDocumentCommonFormAttributesExciseDutyCodes>)) : base(vatWithholdingCode, vatExemptionReasonCode, vatExemptionReason, note, exciseDutyCodes)
        {
        ...
        public EArchiveFormAttributesInternetSale InternetSale { get; set; }

        /// <summary>
        /// Gets or Sets Shipment
        /// </summary>
        [DataMember(Name="shipment", EmitDefaultValue=false)]
        public EArchiveFormAttributesShipment Shipment { get; set; }
        ...
        {
            return this.Equals(input as EArchiveFormAttributes);
        }

        /// <summary>
        /// Returns true if EArchiveFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EArchiveFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EArchiveFormAttributes input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InternetSale == input.InternetSale ||
                    (this.InternetSale != null &&
                    this.InternetSale.Equals(input.InternetSale))
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InternetSale != null)
                    hashCode = hashCode * 59 + this.InternetSale.GetHashCode();
