...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsDetails :  IEquatable<PurchaseBillRelationshipsDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsDetails" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PurchaseBillRelationshipsDetails(List<PurchaseBillRelationshipsDetailsData> data = default(List<PurchaseBillRelationshipsDetailsData>))
        {
            this.Data = data;
        }
        ...
        public List<PurchaseBillRelationshipsDetailsData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsDetails {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsDetails);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsDetails input)
        {
            if (input == null)
                return false;
