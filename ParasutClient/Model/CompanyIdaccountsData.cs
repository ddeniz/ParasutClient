...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdaccountsData :  IEquatable<CompanyIdaccountsData>, IValidatableObject
    {
        ...
        public CompanyIdaccountsData(string id = default(string), TypeEnum? type = default(TypeEnum?), AccountAttributes attributes = default(AccountAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdaccountsData);
        }

        /// <summary>
        /// Returns true if CompanyIdaccountsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdaccountsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdaccountsData input)
        {
            if (input == null)
                return false;
