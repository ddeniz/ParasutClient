...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData :  IEquatable<CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData input)
        {
            if (input == null)
                return false;
