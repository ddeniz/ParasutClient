...
{
    /// <summary>
    /// PaymentRelationshipsPayableData
    /// </summary>
    [DataContract]
    public partial class PaymentRelationshipsPayableData :  IEquatable<PaymentRelationshipsPayableData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRelationshipsPayableData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PaymentRelationshipsPayableData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRelationshipsPayableData {\n");
        ...
        {
            return this.Equals(input as PaymentRelationshipsPayableData);
        }

        /// <summary>
        /// Returns true if PaymentRelationshipsPayableData instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRelationshipsPayableData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRelationshipsPayableData input)
        {
            if (input == null)
                return false;
