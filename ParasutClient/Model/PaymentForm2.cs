...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentForm2 :  IEquatable<PaymentForm2>, IValidatableObject
    {
        ...
        public PaymentForm2(CompanyIdbankFeesidpaymentsData data = default(CompanyIdbankFeesidpaymentsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PaymentForm2 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PaymentForm2);
        }

        /// <summary>
        /// Returns true if PaymentForm2 instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentForm2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentForm2 input)
        {
            if (input == null)
                return false;
