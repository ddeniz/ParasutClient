...
{
    /// <summary>
    /// SalesInvoiceRelationshipsActiveEDocument
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationshipsActiveEDocument :  IEquatable<SalesInvoiceRelationshipsActiveEDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInvoiceRelationshipsActiveEDocument" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public SalesInvoiceRelationshipsActiveEDocument(SalesInvoiceRelationshipsActiveEDocumentData data = default(SalesInvoiceRelationshipsActiveEDocumentData))
        {
            this.Data = data;
        }
        ...
        public SalesInvoiceRelationshipsActiveEDocumentData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationshipsActiveEDocument {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationshipsActiveEDocument);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationshipsActiveEDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationshipsActiveEDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationshipsActiveEDocument input)
        {
            if (input == null)
                return false;
