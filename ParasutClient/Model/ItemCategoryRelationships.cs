...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemCategoryRelationships :  IEquatable<ItemCategoryRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public ItemCategoryRelationshipsSubcategories Subcategories { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemCategoryRelationships {\n");
        ...
        {
            return this.Equals(input as ItemCategoryRelationships);
        }

        /// <summary>
        /// Returns true if ItemCategoryRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemCategoryRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemCategoryRelationships input)
        {
            if (input == null)
                return false;
