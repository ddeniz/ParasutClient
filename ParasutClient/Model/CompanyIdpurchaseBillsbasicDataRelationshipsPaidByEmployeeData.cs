...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData :  IEquatable<CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData input)
        {
            if (input == null)
                return false;
