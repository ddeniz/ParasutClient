...
namespace ParasutClient.Model
{
    ...
    public partial class EDocumentCommonForm :  IEquatable<EDocumentCommonForm>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Edocumentcommons for value: e_document_commons
            /// </summary>
        ...
        public EDocumentCommonForm(string id = default(string), TypeEnum? type = default(TypeEnum?), EDocumentCommonFormAttributes attributes = default(EDocumentCommonFormAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for EDocumentCommonForm and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EDocumentCommonForm);
        }

        /// <summary>
        /// Returns true if EDocumentCommonForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EDocumentCommonForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentCommonForm input)
        {
            if (input == null)
                return false;
