...
namespace ParasutClient.Model
{
    ...
    public partial class EmployeeForm :  IEquatable<EmployeeForm>, IValidatableObject
    {
        ...
        public EmployeeForm(CompanyIdemployeesData data = default(CompanyIdemployeesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for EmployeeForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as EmployeeForm);
        }

        /// <summary>
        /// Returns true if EmployeeForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeForm input)
        {
            if (input == null)
                return false;
