...
{
    /// <summary>
    /// ContactRelationshipsContactPeople
    /// </summary>
    [DataContract]
    public partial class ContactRelationshipsContactPeople :  IEquatable<ContactRelationshipsContactPeople>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactRelationshipsContactPeople" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ContactRelationshipsContactPeople(List<ContactRelationshipsContactPeopleData> data = default(List<ContactRelationshipsContactPeopleData>))
        {
            this.Data = data;
        }
        ...
        public List<ContactRelationshipsContactPeopleData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactRelationshipsContactPeople {\n");
        ...
        {
            return this.Equals(input as ContactRelationshipsContactPeople);
        }

        /// <summary>
        /// Returns true if ContactRelationshipsContactPeople instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactRelationshipsContactPeople to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRelationshipsContactPeople input)
        {
            if (input == null)
                return false;
