...
{
    /// <summary>
    /// ShipmentDocumentRelationships
    /// </summary>
    [DataContract]
    public partial class ShipmentDocumentRelationships :  IEquatable<ShipmentDocumentRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public ShipmentDocumentRelationshipsStockMovements StockMovements { get; set; }

        /// <summary>
        /// Gets or Sets Invoices
        /// </summary>
        [DataMember(Name="invoices", EmitDefaultValue=false)]
        public ShipmentDocumentRelationshipsInvoices Invoices { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDocumentRelationships {\n");
        ...
        {
            return this.Equals(input as ShipmentDocumentRelationships);
        }

        /// <summary>
        /// Returns true if ShipmentDocumentRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentDocumentRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentDocumentRelationships input)
        {
            if (input == null)
                return false;
