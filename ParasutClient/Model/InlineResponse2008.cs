...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(List<Employee> data = default(List<Employee>), List<InlineResponse2008Included> included = default(List<InlineResponse2008Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
