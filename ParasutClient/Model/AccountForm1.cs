...
namespace ParasutClient.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountForm1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountForm1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountForm1" /> class.
        /// </summary>
        ...
        public AccountForm1(CompanyIdaccountsData data = default(CompanyIdaccountsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for AccountForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as AccountForm1);
        }

        /// <summary>
        /// Returns true if AccountForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountForm1 input)
        {
            if (input == null)
                return false;
