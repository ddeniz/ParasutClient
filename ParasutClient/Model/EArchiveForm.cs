...
namespace ParasutClient.Model
{
    ...
    public partial class EArchiveForm :  IEquatable<EArchiveForm>, IValidatableObject
    {
        ...
        public EArchiveForm(CompanyIdeArchivesData data = default(CompanyIdeArchivesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for EArchiveForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as EArchiveForm);
        }

        /// <summary>
        /// Returns true if EArchiveForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EArchiveForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EArchiveForm input)
        {
            if (input == null)
                return false;
