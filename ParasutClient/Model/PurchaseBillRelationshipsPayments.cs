...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsPayments :  IEquatable<PurchaseBillRelationshipsPayments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsPayments" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PurchaseBillRelationshipsPayments(List<PurchaseBillRelationshipsPaymentsData> data = default(List<PurchaseBillRelationshipsPaymentsData>))
        {
            this.Data = data;
        }
        ...
        public List<PurchaseBillRelationshipsPaymentsData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsPayments {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsPayments);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsPayments instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsPayments input)
        {
            if (input == null)
                return false;
