...
{
    /// <summary>
    /// PurchaseBillRelationshipsPaymentsData
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsPaymentsData :  IEquatable<PurchaseBillRelationshipsPaymentsData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsPaymentsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PurchaseBillRelationshipsPaymentsData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsPaymentsData {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsPaymentsData);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsPaymentsData instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsPaymentsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsPaymentsData input)
        {
            if (input == null)
                return false;
