...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactRelationships :  IEquatable<ContactRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactRelationshipsContactPortal ContactPortal { get; set; }

        /// <summary>
        /// Gets or Sets ContactPeople
        /// </summary>
        [DataMember(Name="contact_people", EmitDefaultValue=false)]
        public ContactRelationshipsContactPeople ContactPeople { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactRelationships {\n");
        ...
        {
            return this.Equals(input as ContactRelationships);
        }

        /// <summary>
        /// Returns true if ContactRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRelationships input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ContactPortal == input.ContactPortal ||
                    (this.ContactPortal != null &&
                    this.ContactPortal.Equals(input.ContactPortal))
                ) && 
                (
                    this.ContactPeople == input.ContactPeople ||
                    (this.ContactPeople != null &&
                    this.ContactPeople.Equals(input.ContactPeople))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ContactPortal != null)
                    hashCode = hashCode * 59 + this.ContactPortal.GetHashCode();
                if (this.ContactPeople != null)
                    hashCode = hashCode * 59 + this.ContactPeople.GetHashCode();
                return hashCode;
            }
        }
