...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillDetailedForm :  IEquatable<PurchaseBillDetailedForm>, IValidatableObject
    {
        ...
        protected PurchaseBillDetailedForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillDetailedForm" /> class.
        /// </summary>
        ...
        public PurchaseBillDetailedFormAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as PurchaseBillDetailedForm);
        }

        /// <summary>
        /// Returns true if PurchaseBillDetailedForm instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillDetailedForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillDetailedForm input)
        {
            if (input == null)
                return false;
