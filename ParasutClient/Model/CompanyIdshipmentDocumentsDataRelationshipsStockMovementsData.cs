...
{
    /// <summary>
    /// CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData
    /// </summary>
    [DataContract]
    public partial class CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData :  IEquatable<CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData>, IValidatableObject
    {
        /// <summary>
        ...
        public StockMovementAttributes Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData {\n");
        ...
        {
            return this.Equals(input as CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData);
        }

        /// <summary>
        /// Returns true if CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData input)
        {
            if (input == null)
                return false;
