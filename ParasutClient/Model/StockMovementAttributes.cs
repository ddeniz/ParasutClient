...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StockMovementAttributes :  IEquatable<StockMovementAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StockMovementAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StockMovementAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StockMovementAttributes" /> class.
        /// </summary>
        /// <param name="quantity">Miktar (required).</param>
        public StockMovementAttributes(decimal? quantity = default(decimal?))
        {
            // to ensure "quantity" is required (not null)
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for StockMovementAttributes and cannot be null");
            }
            else
            {
        ...
        /// Detay sıra no
        /// </summary>
        /// <value>Detay sıra no</value>
        [DataMember(Name="detail_no", EmitDefaultValue=false)]
        public decimal? DetailNo { get; private set; }

        /// <summary>
        /// Hareket tarihi
        /// </summary>
        /// <value>Hareket tarihi</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StockMovementAttributes {\n");
            sb.Append("  DetailNo: ").Append(DetailNo).Append("\n");
        ...
        {
            return this.Equals(input as StockMovementAttributes);
        }

        /// <summary>
        /// Returns true if StockMovementAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of StockMovementAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockMovementAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DetailNo == input.DetailNo ||
                    (this.DetailNo != null &&
                    this.DetailNo.Equals(input.DetailNo))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DetailNo != null)
                    hashCode = hashCode * 59 + this.DetailNo.GetHashCode();
                if (this.Date != null)
