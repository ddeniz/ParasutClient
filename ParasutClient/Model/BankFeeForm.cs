...
namespace ParasutClient.Model
{
    ...
    public partial class BankFeeForm :  IEquatable<BankFeeForm>, IValidatableObject
    {
        ...
        public BankFeeForm(CompanyIdbankFeesData data = default(CompanyIdbankFeesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for BankFeeForm and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as BankFeeForm);
        }

        /// <summary>
        /// Returns true if BankFeeForm instances are equal
        /// </summary>
        /// <param name="input">Instance of BankFeeForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankFeeForm input)
        {
            if (input == null)
                return false;
