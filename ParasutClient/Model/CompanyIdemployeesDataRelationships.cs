...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdemployeesDataRelationships :  IEquatable<CompanyIdemployeesDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdemployeesDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdemployeesDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdemployeesDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdemployeesDataRelationships input)
        {
            if (input == null)
                return false;
