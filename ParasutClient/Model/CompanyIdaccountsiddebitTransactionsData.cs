...
{
    /// <summary>
    /// CompanyIdaccountsiddebitTransactionsData
    /// </summary>
    [DataContract]
    public partial class CompanyIdaccountsiddebitTransactionsData :  IEquatable<CompanyIdaccountsiddebitTransactionsData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdaccountsiddebitTransactionsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        public CompanyIdaccountsiddebitTransactionsData(string id = default(string), TypeEnum? type = default(TypeEnum?), AccountDebitCreditTransactionFormAttributes attributes = default(AccountDebitCreditTransactionFormAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdaccountsiddebitTransactionsData {\n");
        ...
        {
            return this.Equals(input as CompanyIdaccountsiddebitTransactionsData);
        }

        /// <summary>
        /// Returns true if CompanyIdaccountsiddebitTransactionsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdaccountsiddebitTransactionsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdaccountsiddebitTransactionsData input)
        {
            if (input == null)
                return false;
