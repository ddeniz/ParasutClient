...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdsalesInvoicesDataRelationshipsDetails :  IEquatable<CompanyIdsalesInvoicesDataRelationshipsDetails>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdsalesInvoicesDataRelationshipsDetails);
        }

        /// <summary>
        /// Returns true if CompanyIdsalesInvoicesDataRelationshipsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalesInvoicesDataRelationshipsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalesInvoicesDataRelationshipsDetails input)
        {
            if (input == null)
                return false;
