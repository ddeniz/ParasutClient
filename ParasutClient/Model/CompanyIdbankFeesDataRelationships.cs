...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdbankFeesDataRelationships :  IEquatable<CompanyIdbankFeesDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdbankFeesDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdbankFeesDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdbankFeesDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdbankFeesDataRelationships input)
        {
            if (input == null)
                return false;
