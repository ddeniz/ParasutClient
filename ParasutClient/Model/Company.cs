...
namespace ParasutClient.Model
{
    ...
    public partial class Company :  IEquatable<Company>, IValidatableObject
    {
        ...
        public Company(string id = default(string), TypeEnum? type = default(TypeEnum?), CompanyAttributes attributes = default(CompanyAttributes), CompanyRelationships relationships = default(CompanyRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Company and cannot be null");
            }
            else
            {
        ...
        public CompanyRelationships Relationships { get; set; }
