...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillBasicForm :  IEquatable<PurchaseBillBasicForm>, IValidatableObject
    {
        ...
        protected PurchaseBillBasicForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillBasicForm" /> class.
        /// </summary>
        ...
        public PurchaseBillBasicForm(string id = default(string), TypeEnum? type = default(TypeEnum?), PurchaseBillBasicFormAttributes attributes = default(PurchaseBillBasicFormAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for PurchaseBillBasicForm and cannot be null");
            }
            else
            {
        ...
        public PurchaseBillBasicFormAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as PurchaseBillBasicForm);
        }

        /// <summary>
        /// Returns true if PurchaseBillBasicForm instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillBasicForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillBasicForm input)
        {
            if (input == null)
                return false;
