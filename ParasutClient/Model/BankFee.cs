...
namespace ParasutClient.Model
{
    ...
    public partial class BankFee :  IEquatable<BankFee>, IValidatableObject
    {
        ...
        public BankFee(string id = default(string), TypeEnum? type = default(TypeEnum?), BankFeeAttributes attributes = default(BankFeeAttributes), CompanyIdbankFeesDataRelationships relationships = default(CompanyIdbankFeesDataRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for BankFee and cannot be null");
            }
            else
            {
        ...
        public BankFeeAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as BankFee);
        }

        /// <summary>
        /// Returns true if BankFee instances are equal
        /// </summary>
        /// <param name="input">Instance of BankFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankFee input)
        {
            if (input == null)
                return false;
