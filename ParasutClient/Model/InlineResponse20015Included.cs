...
{
    /// <summary>
    /// InlineResponse20015Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse20015Included :  IEquatable<InlineResponse20015Included>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20015Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse20015Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20015Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse20015Included);
        }

        /// <summary>
        /// Returns true if InlineResponse20015Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20015Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20015Included input)
        {
            if (input == null)
                return false;
