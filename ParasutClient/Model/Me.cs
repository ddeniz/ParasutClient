...
namespace ParasutClient.Model
{
    ...
    public partial class Me :  IEquatable<Me>, IValidatableObject
    {
        ...
        public Me(string id = default(string), TypeEnum? type = default(TypeEnum?), MeAttributes attributes = default(MeAttributes), MeRelationships relationships = default(MeRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Me and cannot be null");
            }
            else
            {
        ...
        public MeAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public MeRelationships Relationships { get; set; }
