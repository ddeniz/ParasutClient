...
namespace ParasutClient.Model
{
    ...
    public partial class SalesInvoiceForm1 :  IEquatable<SalesInvoiceForm1>, IValidatableObject
    {
        ...
        public SalesInvoiceForm1(CompanyIdsalesInvoicesData data = default(CompanyIdsalesInvoicesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for SalesInvoiceForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as SalesInvoiceForm1);
        }

        /// <summary>
        /// Returns true if SalesInvoiceForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceForm1 input)
        {
            if (input == null)
                return false;
