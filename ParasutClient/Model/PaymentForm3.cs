...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentForm3 :  IEquatable<PaymentForm3>, IValidatableObject
    {
        ...
        public PaymentForm3(CompanyIdbankFeesidpaymentsData data = default(CompanyIdbankFeesidpaymentsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PaymentForm3 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PaymentForm3);
        }

        /// <summary>
        /// Returns true if PaymentForm3 instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentForm3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentForm3 input)
        {
            if (input == null)
                return false;
