...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdcontactsidcontactCreditTransactionsData :  IEquatable<CompanyIdcontactsidcontactCreditTransactionsData>, IValidatableObject
    {
        ...
        public CompanyIdcontactsidcontactCreditTransactionsData(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactPaymentFormAttributes attributes = default(ContactPaymentFormAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdcontactsidcontactCreditTransactionsData);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsidcontactCreditTransactionsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdcontactsidcontactCreditTransactionsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsidcontactCreditTransactionsData input)
        {
            if (input == null)
                return false;
