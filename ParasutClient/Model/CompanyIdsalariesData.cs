...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdsalariesData :  IEquatable<CompanyIdsalariesData>, IValidatableObject
    {
        ...
        public CompanyIdsalariesData(string id = default(string), TypeEnum? type = default(TypeEnum?), SalaryAttributes attributes = default(SalaryAttributes), CompanyIdsalariesDataRelationships relationships = default(CompanyIdsalariesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public SalaryAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdsalariesData);
        }

        /// <summary>
        /// Returns true if CompanyIdsalariesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalariesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalariesData input)
        {
            if (input == null)
                return false;
