...
{
    /// <summary>
    /// InlineResponse2013Included
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013Included :  IEquatable<InlineResponse2013Included>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Bankfees for value: bank_fees
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013Included" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public InlineResponse2013Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2013Included {\n");
        ...
        {
            return this.Equals(input as InlineResponse2013Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2013Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2013Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013Included input)
        {
            if (input == null)
                return false;
