...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountDebitCreditTransactionFormAttributes :  IEquatable<AccountDebitCreditTransactionFormAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDebitCreditTransactionFormAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountDebitCreditTransactionFormAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDebitCreditTransactionFormAttributes" /> class.
        /// </summary>
        /// <param name="date">İşlem Tarihi (required).</param>
        /// <param name="amount">İşlem Tutarı (required).</param>
        /// <param name="description">İşlem Açıklaması.</param>
        public AccountDebitCreditTransactionFormAttributes(DateTime? date = default(DateTime?), decimal? amount = default(decimal?), string description = default(string))
        {
            // to ensure "date" is required (not null)
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for AccountDebitCreditTransactionFormAttributes and cannot be null");
            }
            else
            {
                this.Date = date;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AccountDebitCreditTransactionFormAttributes and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountDebitCreditTransactionFormAttributes {\n");
        ...
        {
            return this.Equals(input as AccountDebitCreditTransactionFormAttributes);
        }

        /// <summary>
        /// Returns true if AccountDebitCreditTransactionFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountDebitCreditTransactionFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountDebitCreditTransactionFormAttributes input)
        {
            if (input == null)
                return false;
