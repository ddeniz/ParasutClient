...
{
    /// <summary>
    /// EmployeeRelationshipsManagedByUserRoleData
    /// </summary>
    [DataContract]
    public partial class EmployeeRelationshipsManagedByUserRoleData :  IEquatable<EmployeeRelationshipsManagedByUserRoleData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Userroles for value: user_roles
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeRelationshipsManagedByUserRoleData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public EmployeeRelationshipsManagedByUserRoleData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmployeeRelationshipsManagedByUserRoleData {\n");
        ...
        {
            return this.Equals(input as EmployeeRelationshipsManagedByUserRoleData);
        }

        /// <summary>
        /// Returns true if EmployeeRelationshipsManagedByUserRoleData instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeRelationshipsManagedByUserRoleData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeRelationshipsManagedByUserRoleData input)
        {
            if (input == null)
                return false;
