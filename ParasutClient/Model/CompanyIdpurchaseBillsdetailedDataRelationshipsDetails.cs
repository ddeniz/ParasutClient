...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedDataRelationshipsDetails :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationshipsDetails>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedDataRelationshipsDetails);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationshipsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedDataRelationshipsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationshipsDetails input)
        {
            if (input == null)
                return false;
