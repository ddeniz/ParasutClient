...
namespace ParasutClient.Model
{
    ...
    public partial class ContactCollectionForm :  IEquatable<ContactCollectionForm>, IValidatableObject
    {
        ...
        protected ContactCollectionForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactCollectionForm" /> class.
        /// </summary>
        ...
        public ContactCollectionForm(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactCollectionFormAttributes attributes = default(ContactCollectionFormAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for ContactCollectionForm and cannot be null");
            }
            else
            {
        ...
        public ContactCollectionFormAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as ContactCollectionForm);
        }

        /// <summary>
        /// Returns true if ContactCollectionForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactCollectionForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactCollectionForm input)
        {
            if (input == null)
                return false;
