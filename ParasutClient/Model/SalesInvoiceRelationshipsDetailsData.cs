...
{
    /// <summary>
    /// SalesInvoiceRelationshipsDetailsData
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationshipsDetailsData :  IEquatable<SalesInvoiceRelationshipsDetailsData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInvoiceRelationshipsDetailsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public SalesInvoiceRelationshipsDetailsData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationshipsDetailsData {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationshipsDetailsData);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationshipsDetailsData instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationshipsDetailsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationshipsDetailsData input)
        {
            if (input == null)
                return false;
