...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeRelationships :  IEquatable<MeRelationships>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeRelationships" /> class.
        /// </summary>
        /// <param name="userRoles">userRoles.</param>
        /// <param name="companies">companies.</param>
        /// <param name="profile">profile.</param>
        public MeRelationships(MeRelationshipsUserRoles userRoles = default(MeRelationshipsUserRoles), MeRelationshipsCompanies companies = default(MeRelationshipsCompanies), MeRelationshipsProfile profile = default(MeRelationshipsProfile))
        {
        ...
        public MeRelationshipsUserRoles UserRoles { get; set; }

        /// <summary>
        /// Gets or Sets Companies
        /// </summary>
        [DataMember(Name="companies", EmitDefaultValue=false)]
        public MeRelationshipsCompanies Companies { get; set; }

        /// <summary>
        /// Gets or Sets Profile
        /// </summary>
        [DataMember(Name="profile", EmitDefaultValue=false)]
        public MeRelationshipsProfile Profile { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeRelationships {\n");
        ...
        {
            return this.Equals(input as MeRelationships);
        }

        /// <summary>
        /// Returns true if MeRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of MeRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeRelationships input)
        {
            if (input == null)
                return false;
