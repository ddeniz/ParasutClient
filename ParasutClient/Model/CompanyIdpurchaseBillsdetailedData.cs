...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedData :  IEquatable<CompanyIdpurchaseBillsdetailedData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedData);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedData input)
        {
            if (input == null)
                return false;
