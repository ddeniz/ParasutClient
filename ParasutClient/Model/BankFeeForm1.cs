...
namespace ParasutClient.Model
{
    ...
    public partial class BankFeeForm1 :  IEquatable<BankFeeForm1>, IValidatableObject
    {
        ...
        public BankFeeForm1(CompanyIdbankFeesData data = default(CompanyIdbankFeesData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for BankFeeForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as BankFeeForm1);
        }

        /// <summary>
        /// Returns true if BankFeeForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of BankFeeForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankFeeForm1 input)
        {
            if (input == null)
                return false;
