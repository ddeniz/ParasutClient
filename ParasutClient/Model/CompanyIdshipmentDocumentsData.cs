...
{
    /// <summary>
    /// CompanyIdshipmentDocumentsData
    /// </summary>
    [DataContract]
    public partial class CompanyIdshipmentDocumentsData :  IEquatable<CompanyIdshipmentDocumentsData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Shipmentdocuments for value: shipment_documents
            /// </summary>
            [EnumMember(Value = "shipment_documents")]
            Shipmentdocuments = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyIdshipmentDocumentsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="relationships">relationships.</param>
        public CompanyIdshipmentDocumentsData(string id = default(string), TypeEnum? type = default(TypeEnum?), ShipmentDocumentAttributes attributes = default(ShipmentDocumentAttributes), CompanyIdshipmentDocumentsDataRelationships relationships = default(CompanyIdshipmentDocumentsDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public ShipmentDocumentAttributes Attributes { get; set; }

        /// <summary>
        /// Gets or Sets Relationships
        /// </summary>
        [DataMember(Name="relationships", EmitDefaultValue=false)]
        public CompanyIdshipmentDocumentsDataRelationships Relationships { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyIdshipmentDocumentsData {\n");
        ...
        {
            return this.Equals(input as CompanyIdshipmentDocumentsData);
        }

        /// <summary>
        /// Returns true if CompanyIdshipmentDocumentsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdshipmentDocumentsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdshipmentDocumentsData input)
        {
            if (input == null)
                return false;
