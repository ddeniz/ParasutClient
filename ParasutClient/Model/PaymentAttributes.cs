...
namespace ParasutClient.Model
{
    ...
    public partial class PaymentAttributes :  IEquatable<PaymentAttributes>, IValidatableObject
    {
        ...
        public PaymentAttributes(DateTime? date = default(DateTime?), decimal? amount = default(decimal?), decimal? currency = default(decimal?), string notes = default(string))
        {
            this.Date = date;
            this.Amount = amount;
        ...
        {
            return this.Equals(input as PaymentAttributes);
        }

        /// <summary>
        /// Returns true if PaymentAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentAttributes input)
        {
            if (input == null)
                return false;
