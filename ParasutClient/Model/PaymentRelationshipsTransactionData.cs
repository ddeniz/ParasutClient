...
{
    /// <summary>
    /// PaymentRelationshipsTransactionData
    /// </summary>
    [DataContract]
    public partial class PaymentRelationshipsTransactionData :  IEquatable<PaymentRelationshipsTransactionData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRelationshipsTransactionData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PaymentRelationshipsTransactionData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRelationshipsTransactionData {\n");
        ...
        {
            return this.Equals(input as PaymentRelationshipsTransactionData);
        }

        /// <summary>
        /// Returns true if PaymentRelationshipsTransactionData instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRelationshipsTransactionData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRelationshipsTransactionData input)
        {
            if (input == null)
                return false;
