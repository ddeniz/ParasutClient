...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdcontactsDataRelationshipsContactPeopleData :  IEquatable<CompanyIdcontactsDataRelationshipsContactPeopleData>, IValidatableObject
    {
        ...
        public CompanyIdcontactsDataRelationshipsContactPeopleData(string id = default(string), TypeEnum? type = default(TypeEnum?), ContactPersonAttributes attributes = default(ContactPersonAttributes))
        {
            this.Id = id;
            this.Type = type;
        ...
        public ContactPersonAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdcontactsDataRelationshipsContactPeopleData);
        }

        /// <summary>
        /// Returns true if CompanyIdcontactsDataRelationshipsContactPeopleData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdcontactsDataRelationshipsContactPeopleData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdcontactsDataRelationshipsContactPeopleData input)
        {
            if (input == null)
                return false;
