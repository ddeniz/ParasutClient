...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdemployeesData :  IEquatable<CompanyIdemployeesData>, IValidatableObject
    {
        ...
        public CompanyIdemployeesData(string id = default(string), TypeEnum? type = default(TypeEnum?), EmployeeAttributes attributes = default(EmployeeAttributes), CompanyIdemployeesDataRelationships relationships = default(CompanyIdemployeesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public EmployeeAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdemployeesData);
        }

        /// <summary>
        /// Returns true if CompanyIdemployeesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdemployeesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdemployeesData input)
        {
            if (input == null)
                return false;
