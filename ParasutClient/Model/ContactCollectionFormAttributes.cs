...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactCollectionFormAttributes : PaymentFormAttributes,  IEquatable<ContactCollectionFormAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactCollectionFormAttributes(List<int?> payableIds = default(List<int?>), string description = default(string), int? accountId = default(int?), DateTime? date = default(DateTime?), decimal? amount = default(decimal?), decimal? exchangeRate = default(decimal?)) : base(description, accountId, date, amount, exchangeRate)
        {
        ...
        {
            return this.Equals(input as ContactCollectionFormAttributes);
        }

        /// <summary>
        /// Returns true if ContactCollectionFormAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactCollectionFormAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactCollectionFormAttributes input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.PayableIds == input.PayableIds ||
                    this.PayableIds != null &&
                    this.PayableIds.SequenceEqual(input.PayableIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PayableIds != null)
                    hashCode = hashCode * 59 + this.PayableIds.GetHashCode();
                return hashCode;
            }
        }
