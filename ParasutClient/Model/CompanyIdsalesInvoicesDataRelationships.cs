...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdsalesInvoicesDataRelationships :  IEquatable<CompanyIdsalesInvoicesDataRelationships>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdsalesInvoicesDataRelationships);
        }

        /// <summary>
        /// Returns true if CompanyIdsalesInvoicesDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalesInvoicesDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalesInvoicesDataRelationships input)
        {
            if (input == null)
                return false;
