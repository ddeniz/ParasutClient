...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesInvoiceRelationshipsSharingsData :  IEquatable<SalesInvoiceRelationshipsSharingsData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInvoiceRelationshipsSharingsData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public SalesInvoiceRelationshipsSharingsData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesInvoiceRelationshipsSharingsData {\n");
        ...
        {
            return this.Equals(input as SalesInvoiceRelationshipsSharingsData);
        }

        /// <summary>
        /// Returns true if SalesInvoiceRelationshipsSharingsData instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesInvoiceRelationshipsSharingsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInvoiceRelationshipsSharingsData input)
        {
            if (input == null)
                return false;
