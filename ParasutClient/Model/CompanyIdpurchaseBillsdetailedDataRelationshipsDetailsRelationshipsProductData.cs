...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData :  IEquatable<CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData);
        }

        /// <summary>
        /// Returns true if CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData input)
        {
            if (input == null)
                return false;
