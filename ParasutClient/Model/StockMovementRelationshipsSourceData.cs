...
{
    /// <summary>
    /// StockMovementRelationshipsSourceData
    /// </summary>
    [DataContract]
    public partial class StockMovementRelationshipsSourceData :  IEquatable<StockMovementRelationshipsSourceData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            Salesinvoicedetails = 2,
            
            /// <summary>
            /// Enum Purchasebilldetails for value: purchase_bill_details
            /// </summary>
            [EnumMember(Value = "purchase_bill_details")]
            Purchasebilldetails = 3
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StockMovementRelationshipsSourceData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public StockMovementRelationshipsSourceData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StockMovementRelationshipsSourceData {\n");
        ...
        {
            return this.Equals(input as StockMovementRelationshipsSourceData);
        }

        /// <summary>
        /// Returns true if StockMovementRelationshipsSourceData instances are equal
        /// </summary>
        /// <param name="input">Instance of StockMovementRelationshipsSourceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockMovementRelationshipsSourceData input)
        {
            if (input == null)
                return false;
