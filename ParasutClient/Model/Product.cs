...
namespace ParasutClient.Model
{
    ...
    public partial class Product :  IEquatable<Product>, IValidatableObject
    {
        ...
        public Product(string id = default(string), TypeEnum? type = default(TypeEnum?), ProductAttributes attributes = default(ProductAttributes), CompanyIdemployeesDataRelationships relationships = default(CompanyIdemployeesDataRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Product and cannot be null");
            }
            else
            {
