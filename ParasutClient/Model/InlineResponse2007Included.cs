...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2007Included :  IEquatable<InlineResponse2007Included>, IValidatableObject
    {
        ...
        public InlineResponse2007Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse2007Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Included input)
        {
            if (input == null)
                return false;
