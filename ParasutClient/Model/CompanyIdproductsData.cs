...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdproductsData :  IEquatable<CompanyIdproductsData>, IValidatableObject
    {
        ...
        public CompanyIdproductsData(string id = default(string), TypeEnum? type = default(TypeEnum?), ProductAttributes attributes = default(ProductAttributes), CompanyIdemployeesDataRelationships relationships = default(CompanyIdemployeesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as CompanyIdproductsData);
        }

        /// <summary>
        /// Returns true if CompanyIdproductsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdproductsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdproductsData input)
        {
            if (input == null)
                return false;
