...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillForm1 :  IEquatable<PurchaseBillForm1>, IValidatableObject
    {
        ...
        public PurchaseBillForm1(CompanyIdpurchaseBillsdetailedData data = default(CompanyIdpurchaseBillsdetailedData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for PurchaseBillForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as PurchaseBillForm1);
        }

        /// <summary>
        /// Returns true if PurchaseBillForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillForm1 input)
        {
            if (input == null)
                return false;
