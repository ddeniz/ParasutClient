...
namespace ParasutClient.Model
{
    ...
    public partial class TagForm1 :  IEquatable<TagForm1>, IValidatableObject
    {
        ...
        public TagForm1(CompanyIdtagsData data = default(CompanyIdtagsData))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for TagForm1 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        {
            return this.Equals(input as TagForm1);
        }

        /// <summary>
        /// Returns true if TagForm1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TagForm1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagForm1 input)
        {
            if (input == null)
                return false;
