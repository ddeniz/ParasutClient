...
namespace ParasutClient.Model
{
    ...
    public partial class EDocumentPdf :  IEquatable<EDocumentPdf>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Edocumentpdfs for value: e_document_pdfs
            /// </summary>
        ...
        public EDocumentPdf(string id = default(string), TypeEnum? type = default(TypeEnum?), EDocumentPdfAttributes attributes = default(EDocumentPdfAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for EDocumentPdf and cannot be null");
            }
            else
            {
        ...
        public EDocumentPdfAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as EDocumentPdf);
        }

        /// <summary>
        /// Returns true if EDocumentPdf instances are equal
        /// </summary>
        /// <param name="input">Instance of EDocumentPdf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EDocumentPdf input)
        {
            if (input == null)
                return false;
