...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(List<Transaction> data = default(List<Transaction>), List<InlineResponse2001Included> included = default(List<InlineResponse2001Included>), ListMeta meta = default(ListMeta))
        {
            this.Data = data;
