...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdtaxesData :  IEquatable<CompanyIdtaxesData>, IValidatableObject
    {
        ...
        public CompanyIdtaxesData(string id = default(string), TypeEnum? type = default(TypeEnum?), TaxAttributes attributes = default(TaxAttributes), CompanyIdbankFeesDataRelationships relationships = default(CompanyIdbankFeesDataRelationships))
        {
            this.Id = id;
            this.Type = type;
        ...
        public TaxAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdtaxesData);
        }

        /// <summary>
        /// Returns true if CompanyIdtaxesData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdtaxesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdtaxesData input)
        {
            if (input == null)
                return false;
