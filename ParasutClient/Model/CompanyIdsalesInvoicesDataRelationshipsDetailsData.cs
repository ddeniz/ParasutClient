...
namespace ParasutClient.Model
{
    ...
    public partial class CompanyIdsalesInvoicesDataRelationshipsDetailsData :  IEquatable<CompanyIdsalesInvoicesDataRelationshipsDetailsData>, IValidatableObject
    {
        ...
        public SalesInvoiceDetailAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as CompanyIdsalesInvoicesDataRelationshipsDetailsData);
        }

        /// <summary>
        /// Returns true if CompanyIdsalesInvoicesDataRelationshipsDetailsData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyIdsalesInvoicesDataRelationshipsDetailsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIdsalesInvoicesDataRelationshipsDetailsData input)
        {
            if (input == null)
                return false;
