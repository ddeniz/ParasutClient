...
{
    /// <summary>
    /// PurchaseBillRelationshipsActiveEDocumentData
    /// </summary>
    [DataContract]
    public partial class PurchaseBillRelationshipsActiveEDocumentData :  IEquatable<PurchaseBillRelationshipsActiveEDocumentData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseBillRelationshipsActiveEDocumentData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public PurchaseBillRelationshipsActiveEDocumentData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PurchaseBillRelationshipsActiveEDocumentData {\n");
        ...
        {
            return this.Equals(input as PurchaseBillRelationshipsActiveEDocumentData);
        }

        /// <summary>
        /// Returns true if PurchaseBillRelationshipsActiveEDocumentData instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillRelationshipsActiveEDocumentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillRelationshipsActiveEDocumentData input)
        {
            if (input == null)
                return false;
