...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(EArchive data = default(EArchive), List<InlineResponse2004Included> included = default(List<InlineResponse2004Included>))
        {
            this.Data = data;
        ...
        public EArchive Data { get; set; }

        /// <summary>
        /// Gets or Sets Included
        /// </summary>
        [DataMember(Name="included", EmitDefaultValue=false)]
        public List<InlineResponse2004Included> Included { get; set; }
