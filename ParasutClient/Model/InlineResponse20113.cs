...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse20113 :  IEquatable<InlineResponse20113>, IValidatableObject
    {
        ...
        public InlineResponse20113(Tag data = default(Tag))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as InlineResponse20113);
        }

        /// <summary>
        /// Returns true if InlineResponse20113 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20113 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20113 input)
        {
            if (input == null)
                return false;
