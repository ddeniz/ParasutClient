...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactRelationshipsContactPortalData :  IEquatable<ContactRelationshipsContactPortalData>, IValidatableObject
    {
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Contactportals for value: contact_portals
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactRelationshipsContactPortalData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">Type of the resource.</param>
        public ContactRelationshipsContactPortalData(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactRelationshipsContactPortalData {\n");
        ...
        {
            return this.Equals(input as ContactRelationshipsContactPortalData);
        }

        /// <summary>
        /// Returns true if ContactRelationshipsContactPortalData instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactRelationshipsContactPortalData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactRelationshipsContactPortalData input)
        {
            if (input == null)
                return false;
