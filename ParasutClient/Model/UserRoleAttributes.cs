...
namespace ParasutClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserRoleAttributes :  IEquatable<UserRoleAttributes>, IValidatableObject
    {
        /// <summary>
        /// Defines SalesInvoices
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SalesInvoicesEnum
        {
        ...
        /// <summary>
        /// Gets or Sets SalesInvoices
        /// </summary>
        [DataMember(Name="sales_invoices", EmitDefaultValue=false)]
        public SalesInvoicesEnum? SalesInvoices { get; set; }
        /// <summary>
        /// Defines Expenditures
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ExpendituresEnum
        {
        ...
        /// <summary>
        /// Gets or Sets Expenditures
        /// </summary>
        [DataMember(Name="expenditures", EmitDefaultValue=false)]
        public ExpendituresEnum? Expenditures { get; set; }
        /// <summary>
        /// Defines OwnExpenditures
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum OwnExpendituresEnum
        {
        ...
        /// <summary>
        /// Gets or Sets OwnExpenditures
        /// </summary>
        [DataMember(Name="own_expenditures", EmitDefaultValue=false)]
        public OwnExpendituresEnum? OwnExpenditures { get; set; }
        /// <summary>
        /// Defines Employees
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        public EmployeesEnum? Employees { get; set; }
        /// <summary>
        /// Defines Accounts
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        public AccountsEnum? Accounts { get; set; }
        /// <summary>
        /// Defines Settings
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRoleAttributes" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserRoleAttributes {\n");
            sb.Append("  SalesInvoices: ").Append(SalesInvoices).Append("\n");
            sb.Append("  Expenditures: ").Append(Expenditures).Append("\n");
            sb.Append("  OwnExpenditures: ").Append(OwnExpenditures).Append("\n");
        ...
        {
            return this.Equals(input as UserRoleAttributes);
        }

        /// <summary>
        /// Returns true if UserRoleAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of UserRoleAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserRoleAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.SalesInvoices == input.SalesInvoices ||
                    (this.SalesInvoices != null &&
                    this.SalesInvoices.Equals(input.SalesInvoices))
                ) && 
                (
                    this.Expenditures == input.Expenditures ||
                    (this.Expenditures != null &&
                    this.Expenditures.Equals(input.Expenditures))
                ) && 
                (
                    this.OwnExpenditures == input.OwnExpenditures ||
                    (this.OwnExpenditures != null &&
                    this.OwnExpenditures.Equals(input.OwnExpenditures))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SalesInvoices != null)
                    hashCode = hashCode * 59 + this.SalesInvoices.GetHashCode();
                if (this.Expenditures != null)
                    hashCode = hashCode * 59 + this.Expenditures.GetHashCode();
                if (this.OwnExpenditures != null)
                    hashCode = hashCode * 59 + this.OwnExpenditures.GetHashCode();
