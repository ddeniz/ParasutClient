...
{
    /// <summary>
    /// CompanyRelationshipsAddress
    /// </summary>
    [DataContract]
    public partial class CompanyRelationshipsAddress :  IEquatable<CompanyRelationshipsAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyRelationshipsAddress" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CompanyRelationshipsAddress(CompanyRelationshipsAddressData data = default(CompanyRelationshipsAddressData))
        {
            this.Data = data;
        }
        ...
        public CompanyRelationshipsAddressData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyRelationshipsAddress {\n");
        ...
        {
            return this.Equals(input as CompanyRelationshipsAddress);
        }

        /// <summary>
        /// Returns true if CompanyRelationshipsAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyRelationshipsAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyRelationshipsAddress input)
        {
            if (input == null)
                return false;
