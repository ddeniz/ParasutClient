...
{
    /// <summary>
    /// MeRelationshipsCompanies
    /// </summary>
    [DataContract]
    public partial class MeRelationshipsCompanies :  IEquatable<MeRelationshipsCompanies>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeRelationshipsCompanies" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MeRelationshipsCompanies(List<AddressRelationshipsAddressableData> data = default(List<AddressRelationshipsAddressableData>))
        {
            this.Data = data;
        }
        ...
        public List<AddressRelationshipsAddressableData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeRelationshipsCompanies {\n");
        ...
        {
            return this.Equals(input as MeRelationshipsCompanies);
        }

        /// <summary>
        /// Returns true if MeRelationshipsCompanies instances are equal
        /// </summary>
        /// <param name="input">Instance of MeRelationshipsCompanies to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeRelationshipsCompanies input)
        {
            if (input == null)
                return false;
