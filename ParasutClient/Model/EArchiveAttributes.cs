...
namespace ParasutClient.Model
{
    ...
    public partial class EArchiveAttributes :  IEquatable<EArchiveAttributes>, IValidatableObject
    {
        ...
        public enum StatusEnum
        {
            ...
            /// <summary>
            /// Enum Legalized for value: legalized
            /// </summary>
        ...
        {
            return this.Equals(input as EArchiveAttributes);
        }

        /// <summary>
        /// Returns true if EArchiveAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of EArchiveAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EArchiveAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsPrinted == input.IsPrinted ||
                    (this.IsPrinted != null &&
                    this.IsPrinted.Equals(input.IsPrinted))
                ) && 
                (
                ...
                (
                    this.CancellableUntil == input.CancellableUntil ||
                    (this.CancellableUntil != null &&
                    this.CancellableUntil.Equals(input.CancellableUntil))
                ) && 
                (
