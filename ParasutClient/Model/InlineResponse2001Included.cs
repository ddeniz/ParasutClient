...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2001Included :  IEquatable<InlineResponse2001Included>, IValidatableObject
    {
        ...
        public InlineResponse2001Included(string id = default(string), TypeEnum? type = default(TypeEnum?), Object attributes = default(Object), Object relationships = default(Object))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse2001Included);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Included instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Included to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Included input)
        {
            if (input == null)
                return false;
