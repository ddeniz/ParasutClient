...
namespace ParasutClient.Model
{
    ...
    public partial class PurchaseBillDetail :  IEquatable<PurchaseBillDetail>, IValidatableObject
    {
        ...
        public PurchaseBillDetail(string id = default(string), TypeEnum? type = default(TypeEnum?), PurchaseBillDetailAttributes attributes = default(PurchaseBillDetailAttributes), CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships relationships = default(CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for PurchaseBillDetail and cannot be null");
            }
            else
            {
        ...
        public PurchaseBillDetailAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as PurchaseBillDetail);
        }

        /// <summary>
        /// Returns true if PurchaseBillDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseBillDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseBillDetail input)
        {
            if (input == null)
                return false;
