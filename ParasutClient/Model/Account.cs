...
namespace ParasutClient.Model
{
    ...
    public partial class Account :  IEquatable<Account>, IValidatableObject
    {
        ...
        public Account(string id = default(string), TypeEnum? type = default(TypeEnum?), AccountAttributes attributes = default(AccountAttributes), Object relationships = default(Object))
        {
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for Account and cannot be null");
            }
            else
            {
