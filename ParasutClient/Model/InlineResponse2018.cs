...
namespace ParasutClient.Model
{
    ...
    public partial class InlineResponse2018 :  IEquatable<InlineResponse2018>, IValidatableObject
    {
        ...
        public InlineResponse2018(Product data = default(Product), List<InlineResponse2009Included> included = default(List<InlineResponse2009Included>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as InlineResponse2018);
        }

        /// <summary>
        /// Returns true if InlineResponse2018 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2018 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2018 input)
        {
            if (input == null)
                return false;
