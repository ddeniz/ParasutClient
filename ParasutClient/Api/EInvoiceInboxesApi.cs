...
namespace ParasutClient.Api
{
    ...
    public interface IEInvoiceInboxesApi : IApiAccessor
    {
        ...
        InlineResponse2006 ListEInvoiceInboxes (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null);
        ...
        ApiResponse<InlineResponse2006> ListEInvoiceInboxesWithHttpInfo (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null);
        ...
        System.Threading.Tasks.Task<InlineResponse2006> ListEInvoiceInboxesAsync (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2006>> ListEInvoiceInboxesAsyncWithHttpInfo (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null);
    ...
    public partial class EInvoiceInboxesApi : IEInvoiceInboxesApi
    {
        ...
        /// <returns></returns>
        public EInvoiceInboxesApi(ParasutClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="pageSize">Page Size (optional, default to 15)</param>
        /// <returns>InlineResponse2006</returns>
        public InlineResponse2006 ListEInvoiceInboxes (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null)
        {
             ApiResponse<InlineResponse2006> localVarResponse = ListEInvoiceInboxesWithHttpInfo(companyId, filterVkn, pageNumber, pageSize);
        ...
        /// <param name="pageSize">Page Size (optional, default to 15)</param>
        /// <returns>ApiResponse of InlineResponse2006</returns>
        public ApiResponse< InlineResponse2006 > ListEInvoiceInboxesWithHttpInfo (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null)
        {
            ...
            if (filterVkn != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "filter[vkn]", filterVkn)); // query parameter
        ...
        /// <param name="pageSize">Page Size (optional, default to 15)</param>
        /// <returns>Task of InlineResponse2006</returns>
        public async System.Threading.Tasks.Task<InlineResponse2006> ListEInvoiceInboxesAsync (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null)
        {
             ApiResponse<InlineResponse2006> localVarResponse = await ListEInvoiceInboxesAsyncWithHttpInfo(companyId, filterVkn, pageNumber, pageSize);
             return localVarResponse.Data;
        ...
        /// <param name="pageSize">Page Size (optional, default to 15)</param>
        /// <returns>Task of ApiResponse (InlineResponse2006)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2006>> ListEInvoiceInboxesAsyncWithHttpInfo (int? companyId, int? filterVkn = null, int? pageNumber = null, int? pageSize = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling EInvoiceInboxesApi->ListEInvoiceInboxes");
