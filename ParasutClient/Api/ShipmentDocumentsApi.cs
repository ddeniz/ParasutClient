...
namespace ParasutClient.Api
{
    ...
    /// </summary>
    public interface IShipmentDocumentsApi : IApiAccessor
    {
        ...
        /// <param name="shipmentDocumentForm"></param>
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20112</returns>
        InlineResponse20112 CreateShipmentDocument (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null);
        ...
        ApiResponse<InlineResponse20112> CreateShipmentDocumentWithHttpInfo (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null);
        /// <summary>
        /// Delete
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="ParasutClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="companyId">Firma ID</param>
        /// <param name="id">İrsaliye ID</param>
        /// <returns>Object</returns>
        Object DeleteShipmentDocument (int? companyId, int? id);
        ...
        ApiResponse<Object> DeleteShipmentDocumentWithHttpInfo (int? companyId, int? id);
        /// <summary>
        /// Index
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="ParasutClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="companyId">Firma ID</param>
        /// <param name="filterFlowType"> (optional)</param>
        /// <param name="filterInvoiceStatus"> (optional)</param>
        /// <param name="filterArchived"> (optional)</param>
        /// <param name="sort">Sortable parameters - *Available: id, issue_date, description, inflow* (optional, default to id)</param>
        /// <param name="pageNumber">Page Number (optional, default to 1)</param>
        /// <param name="pageSize">Page Size (optional, default to 15)</param>
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20014</returns>
        InlineResponse20014 ListShipmentDocuments (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        ...
        ApiResponse<InlineResponse20014> ListShipmentDocumentsWithHttpInfo (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        /// <summary>
        /// Show
        /// </summary>
        /// <remarks>
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20112</returns>
        InlineResponse20112 ShowShipmentDocument (int? companyId, int? id, string include = null);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20112</returns>
        ApiResponse<InlineResponse20112> ShowShipmentDocumentWithHttpInfo (int? companyId, int? id, string include = null);
        /// <summary>
        /// Edit
        /// </summary>
        /// <remarks>
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20112</returns>
        InlineResponse20112 UpdateShipmentDocument (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20112</returns>
        ApiResponse<InlineResponse20112> UpdateShipmentDocumentWithHttpInfo (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null);
        ...
        System.Threading.Tasks.Task<InlineResponse20112> CreateShipmentDocumentAsync (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20112>> CreateShipmentDocumentAsyncWithHttpInfo (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null);
        /// <summary>
        /// Delete
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Object> DeleteShipmentDocumentAsync (int? companyId, int? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteShipmentDocumentAsyncWithHttpInfo (int? companyId, int? id);
        /// <summary>
        /// Index
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse20014> ListShipmentDocumentsAsync (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20014>> ListShipmentDocumentsAsyncWithHttpInfo (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        /// <summary>
        /// Show
        /// </summary>
        /// <remarks>
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of InlineResponse20112</returns>
        System.Threading.Tasks.Task<InlineResponse20112> ShowShipmentDocumentAsync (int? companyId, int? id, string include = null);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20112)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20112>> ShowShipmentDocumentAsyncWithHttpInfo (int? companyId, int? id, string include = null);
        /// <summary>
        /// Edit
        /// </summary>
        /// <remarks>
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of InlineResponse20112</returns>
        System.Threading.Tasks.Task<InlineResponse20112> UpdateShipmentDocumentAsync (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20112)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20112>> UpdateShipmentDocumentAsyncWithHttpInfo (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ShipmentDocumentsApi : IShipmentDocumentsApi
    {
        private ParasutClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDocumentsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ShipmentDocumentsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ShipmentDocumentsApi(ParasutClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20112</returns>
        public InlineResponse20112 CreateShipmentDocument (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null)
        {
             ApiResponse<InlineResponse20112> localVarResponse = CreateShipmentDocumentWithHttpInfo(companyId, shipmentDocumentForm, include);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20112</returns>
        public ApiResponse< InlineResponse20112 > CreateShipmentDocumentWithHttpInfo (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->CreateShipmentDocument");
            // verify the required parameter 'shipmentDocumentForm' is set
            if (shipmentDocumentForm == null)
                throw new ApiException(400, "Missing required parameter 'shipmentDocumentForm' when calling ShipmentDocumentsApi->CreateShipmentDocument");

            var localVarPath = "/{company_id}/shipment_documents";
            ...
            if (shipmentDocumentForm != null && shipmentDocumentForm.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(shipmentDocumentForm); // http body (model) parameter
            }
            else
            {
                localVarPostBody = shipmentDocumentForm; // byte array
            }
            ...
            {
                Exception exception = ExceptionFactory("CreateShipmentDocument", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<InlineResponse20112>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (InlineResponse20112) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(InlineResponse20112)));
        }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of InlineResponse20112</returns>
        public async System.Threading.Tasks.Task<InlineResponse20112> CreateShipmentDocumentAsync (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null)
        {
             ApiResponse<InlineResponse20112> localVarResponse = await CreateShipmentDocumentAsyncWithHttpInfo(companyId, shipmentDocumentForm, include);
             return localVarResponse.Data;
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20112)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse20112>> CreateShipmentDocumentAsyncWithHttpInfo (int? companyId, ShipmentDocumentForm shipmentDocumentForm, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->CreateShipmentDocument");
        ...
        /// <param name="id">İrsaliye ID</param>
        /// <returns>Object</returns>
        public Object DeleteShipmentDocument (int? companyId, int? id)
        {
             ApiResponse<Object> localVarResponse = DeleteShipmentDocumentWithHttpInfo(companyId, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">İrsaliye ID</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > DeleteShipmentDocumentWithHttpInfo (int? companyId, int? id)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->DeleteShipmentDocument");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ShipmentDocumentsApi->DeleteShipmentDocument");

            var localVarPath = "/{company_id}/shipment_documents/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteShipmentDocument", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="id">İrsaliye ID</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> DeleteShipmentDocumentAsync (int? companyId, int? id)
        {
             ApiResponse<Object> localVarResponse = await DeleteShipmentDocumentAsyncWithHttpInfo(companyId, id);
             return localVarResponse.Data;
        ...
        /// <param name="id">İrsaliye ID</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteShipmentDocumentAsyncWithHttpInfo (int? companyId, int? id)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->DeleteShipmentDocument");
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20014</returns>
        public InlineResponse20014 ListShipmentDocuments (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
             ApiResponse<InlineResponse20014> localVarResponse = ListShipmentDocumentsWithHttpInfo(companyId, filterFlowType, filterInvoiceStatus, filterArchived, sort, pageNumber, pageSize, include);
             return localVarResponse.Data;
        }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20014</returns>
        public ApiResponse< InlineResponse20014 > ListShipmentDocumentsWithHttpInfo (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->ListShipmentDocuments");
            ...
            if (companyId != null) localVarPathParams.Add("company_id", this.Configuration.ApiClient.ParameterToString(companyId)); // path parameter
            if (filterFlowType != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "filter[flow_type]", filterFlowType)); // query parameter
            if (filterInvoiceStatus != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "filter[invoice_status]", filterInvoiceStatus)); // query parameter
            if (filterArchived != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "filter[archived]", filterArchived)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListShipmentDocuments", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of InlineResponse20014</returns>
        public async System.Threading.Tasks.Task<InlineResponse20014> ListShipmentDocumentsAsync (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
             ApiResponse<InlineResponse20014> localVarResponse = await ListShipmentDocumentsAsyncWithHttpInfo(companyId, filterFlowType, filterInvoiceStatus, filterArchived, sort, pageNumber, pageSize, include);
             return localVarResponse.Data;
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20014)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse20014>> ListShipmentDocumentsAsyncWithHttpInfo (int? companyId, string filterFlowType = null, string filterInvoiceStatus = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->ListShipmentDocuments");
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20112</returns>
        public InlineResponse20112 ShowShipmentDocument (int? companyId, int? id, string include = null)
        {
             ApiResponse<InlineResponse20112> localVarResponse = ShowShipmentDocumentWithHttpInfo(companyId, id, include);
             return localVarResponse.Data;
        }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20112</returns>
        public ApiResponse< InlineResponse20112 > ShowShipmentDocumentWithHttpInfo (int? companyId, int? id, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->ShowShipmentDocument");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ShipmentDocumentsApi->ShowShipmentDocument");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ShowShipmentDocument", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of InlineResponse20112</returns>
        public async System.Threading.Tasks.Task<InlineResponse20112> ShowShipmentDocumentAsync (int? companyId, int? id, string include = null)
        {
             ApiResponse<InlineResponse20112> localVarResponse = await ShowShipmentDocumentAsyncWithHttpInfo(companyId, id, include);
             return localVarResponse.Data;
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20112)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse20112>> ShowShipmentDocumentAsyncWithHttpInfo (int? companyId, int? id, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->ShowShipmentDocument");
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>InlineResponse20112</returns>
        public InlineResponse20112 UpdateShipmentDocument (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null)
        {
             ApiResponse<InlineResponse20112> localVarResponse = UpdateShipmentDocumentWithHttpInfo(companyId, id, shipmentDocumentForm, include);
             return localVarResponse.Data;
        }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20112</returns>
        public ApiResponse< InlineResponse20112 > UpdateShipmentDocumentWithHttpInfo (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->UpdateShipmentDocument");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ShipmentDocumentsApi->UpdateShipmentDocument");
            // verify the required parameter 'shipmentDocumentForm' is set
            if (shipmentDocumentForm == null)
                throw new ApiException(400, "Missing required parameter 'shipmentDocumentForm' when calling ShipmentDocumentsApi->UpdateShipmentDocument");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdateShipmentDocument", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of InlineResponse20112</returns>
        public async System.Threading.Tasks.Task<InlineResponse20112> UpdateShipmentDocumentAsync (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null)
        {
             ApiResponse<InlineResponse20112> localVarResponse = await UpdateShipmentDocumentAsyncWithHttpInfo(companyId, id, shipmentDocumentForm, include);
             return localVarResponse.Data;
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20112)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse20112>> UpdateShipmentDocumentAsyncWithHttpInfo (int? companyId, int? id, ShipmentDocumentForm1 shipmentDocumentForm, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling ShipmentDocumentsApi->UpdateShipmentDocument");
