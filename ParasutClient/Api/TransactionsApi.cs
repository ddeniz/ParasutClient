...
namespace ParasutClient.Api
{
    ...
    public interface ITransactionsApi : IApiAccessor
    {
        ...
        InlineResponse2011 ShowTransaction (int? companyId, int? id, string include = null);
        ...
        ApiResponse<InlineResponse2011> ShowTransactionWithHttpInfo (int? companyId, int? id, string include = null);
        ...
        System.Threading.Tasks.Task<InlineResponse2011> ShowTransactionAsync (int? companyId, int? id, string include = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2011>> ShowTransactionAsyncWithHttpInfo (int? companyId, int? id, string include = null);
    ...
    public partial class TransactionsApi : ITransactionsApi
    {
        ...
        /// <returns></returns>
        public TransactionsApi(ParasutClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: debit_account, credit_account, payments* (optional)</param>
        /// <returns>InlineResponse2011</returns>
        public InlineResponse2011 ShowTransaction (int? companyId, int? id, string include = null)
        {
             ApiResponse<InlineResponse2011> localVarResponse = ShowTransactionWithHttpInfo(companyId, id, include);
             return localVarResponse.Data;
        }
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: debit_account, credit_account, payments* (optional)</param>
        /// <returns>ApiResponse of InlineResponse2011</returns>
        public ApiResponse< InlineResponse2011 > ShowTransactionWithHttpInfo (int? companyId, int? id, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: debit_account, credit_account, payments* (optional)</param>
        /// <returns>Task of InlineResponse2011</returns>
        public async System.Threading.Tasks.Task<InlineResponse2011> ShowTransactionAsync (int? companyId, int? id, string include = null)
        {
             ApiResponse<InlineResponse2011> localVarResponse = await ShowTransactionAsyncWithHttpInfo(companyId, id, include);
             return localVarResponse.Data;
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: debit_account, credit_account, payments* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2011)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2011>> ShowTransactionAsyncWithHttpInfo (int? companyId, int? id, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling TransactionsApi->ShowTransaction");
