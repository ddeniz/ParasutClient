...
namespace ParasutClient.Api
{
    ...
    public interface ITrackableJobsApi : IApiAccessor
    {
        ...
        InlineResponse2015 ShowTrackableJob (int? companyId, int? id);
        ...
        ApiResponse<InlineResponse2015> ShowTrackableJobWithHttpInfo (int? companyId, int? id);
        ...
        System.Threading.Tasks.Task<InlineResponse2015> ShowTrackableJobAsync (int? companyId, int? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2015>> ShowTrackableJobAsyncWithHttpInfo (int? companyId, int? id);
    ...
    public partial class TrackableJobsApi : ITrackableJobsApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public TrackableJobsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public TrackableJobsApi(ParasutClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id">Trackable Job ID</param>
        /// <returns>InlineResponse2015</returns>
        public InlineResponse2015 ShowTrackableJob (int? companyId, int? id)
        {
        ...
        /// <param name="id">Trackable Job ID</param>
        /// <returns>ApiResponse of InlineResponse2015</returns>
        public ApiResponse< InlineResponse2015 > ShowTrackableJobWithHttpInfo (int? companyId, int? id)
        {
        ...
        /// <param name="id">Trackable Job ID</param>
        /// <returns>Task of InlineResponse2015</returns>
        public async System.Threading.Tasks.Task<InlineResponse2015> ShowTrackableJobAsync (int? companyId, int? id)
        {
        ...
        /// <param name="id">Trackable Job ID</param>
        /// <returns>Task of ApiResponse (InlineResponse2015)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2015>> ShowTrackableJobAsyncWithHttpInfo (int? companyId, int? id)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling TrackableJobsApi->ShowTrackableJob");
