...
namespace ParasutClient.Api
{
    ...
    /// </summary>
    public interface IStockMovementsApi : IApiAccessor
    {
        ...
        /// <param name="sort">Sortable parameters - *Available: id, date* (optional, default to id)</param>
        /// <param name="pageNumber">Page Number (optional, default to 1)</param>
        /// <param name="pageSize">Page Size (optional, default to 15)</param>
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: product, source, contact* (optional)</param>
        /// <returns>InlineResponse20015</returns>
        InlineResponse20015 ListStockMovements (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        ...
        ApiResponse<InlineResponse20015> ListStockMovementsWithHttpInfo (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        ...
        System.Threading.Tasks.Task<InlineResponse20015> ListStockMovementsAsync (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20015>> ListStockMovementsAsyncWithHttpInfo (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class StockMovementsApi : IStockMovementsApi
    {
        private ParasutClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="StockMovementsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public StockMovementsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public StockMovementsApi(ParasutClient.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Index Tüm stok hareketlerini listeler. Her irsaliye oluşturulurken stok hareketi de oluşturulur. Buna ilave olarak, irsaliyeli satış faturası veya irsaliyeli alış faturası oluşturulduğunda stok takibi yapılan bir ürün içeren her fatura kalemine karşılık otomatik olarak bir stok hareketi oluşur.
        /// </summary>
        /// <exception cref="ParasutClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="companyId">Firma ID</param>
        /// <param name="sort">Sortable parameters - *Available: id, date* (optional, default to id)</param>
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: product, source, contact* (optional)</param>
        /// <returns>InlineResponse20015</returns>
        public InlineResponse20015 ListStockMovements (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
             ApiResponse<InlineResponse20015> localVarResponse = ListStockMovementsWithHttpInfo(companyId, sort, pageNumber, pageSize, include);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: product, source, contact* (optional)</param>
        /// <returns>ApiResponse of InlineResponse20015</returns>
        public ApiResponse< InlineResponse20015 > ListStockMovementsWithHttpInfo (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling StockMovementsApi->ListStockMovements");

            var localVarPath = "/{company_id}/stock_movements";
            ...
            {
                Exception exception = ExceptionFactory("ListStockMovements", localVarResponse);
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: product, source, contact* (optional)</param>
        /// <returns>Task of InlineResponse20015</returns>
        public async System.Threading.Tasks.Task<InlineResponse20015> ListStockMovementsAsync (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
             ApiResponse<InlineResponse20015> localVarResponse = await ListStockMovementsAsyncWithHttpInfo(companyId, sort, pageNumber, pageSize, include);
             return localVarResponse.Data;
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: product, source, contact* (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse20015)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse20015>> ListStockMovementsAsyncWithHttpInfo (int? companyId, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling StockMovementsApi->ListStockMovements");
